/*
 * Vec/codegen/lib/petscVecSetSizes/petscVecSetSizes_mex.c
 *
 * Auxiliary code for mexFunction of petscVecSetSizes
 *
 * C source code generated by m2c.
 * %#m2c options: codegenArgs=-args {PetscVec, int32(0), int32(0)} petscVecSetSizes_Local -args {PetscVec, int32(0)} enableInline=1 presVars=None dynMem=Threshold
 *
 */
