...
static void __petscVecSetSizes_api(mxArray **plhs, const mxArray ** prhs) {
...
static void __petscVecSetSizes_Local_api(mxArray **plhs, const mxArray ** prhs) {
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[1], mxLOGICAL_CLASS, 2, l_size); }
    ...
    /* Invoke the target function */
    petscVecSetSizes_Local(&vec, n, errCode, toplevel);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 3) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscVecSetSizes:TooManyOutputArguments",
                "Too many output arguments for entry-point petscVecSetSizes.\n");
        /* Call the API function. */
        __petscVecSetSizes_api(outputs, prhs);
    }
    else if (nrhs == 2) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscVecSetSizes_Local:TooManyOutputArguments",
                "Too many output arguments for entry-point petscVecSetSizes_Local.\n");
        /* Call the API function. */
        __petscVecSetSizes_Local_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscVecSetSizes:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscVecSetSizes.");
