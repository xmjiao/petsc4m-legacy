...
static void b_m2c_error(int varargin_3)
{
  ...
  fmt = "VecAssemblyEnd returned error code %d\n";
...
void petscVecAssemblyEnd(const struct0_T *vec, int *errCode, boolean_T *toplevel)
{
  boolean_T p;
  boolean_T b_p;
  int k;
...
void petscVecAssemblyEnd_initialize(void)
{
}

void petscVecAssemblyEnd_terminate(void)
{
}
