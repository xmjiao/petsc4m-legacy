...
static void b_m2c_error(int varargin_3)
{
  ...
  fmt = "VecGetLocalSize returned error code %d\n";
...
void petscVecGetLocalSize(const struct0_T *vec, int *n, int *errCode, boolean_T *
  toplevel)
{
  boolean_T p;
  boolean_T b_p;
...
void petscVecGetLocalSize_initialize(void)
{
}

void petscVecGetLocalSize_terminate(void)
{
}
