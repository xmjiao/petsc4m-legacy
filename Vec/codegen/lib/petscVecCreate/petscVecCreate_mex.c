/*
 * Vec/codegen/lib/petscVecCreate/petscVecCreate_mex.c
 *
 * Auxiliary code for mexFunction of petscVecCreate
 *
 * C source code generated by m2c.
 * %#m2c options: codegenArgs=-args {MPI_Comm} petscVecCreate_World -args {} enableInline=1 presVars=None dynMem=Threshold
 *
 */
...
void petscVecCreate_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[2], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscVecCreate_initialize();

    petscVecCreate(&comm, &vec, errCode, toplevel);

    petscVecCreate_terminate();
...
void petscVecCreate_World_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&topleve = prealloc_mxArray((mxArray**)&plhs[2], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscVecCreate_World(&vec, errCode, topleve);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscVecCreate:TooManyOutputArguments","Too many output arguments for entry-point petscVecCreate.");
        /* Call the API function. */
        petscVecCreate_api(prhs, (const mxArray**)outputs);
    }
    else if (nrhs == 0) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscVecCreate_World:TooManyOutputArguments","Too many output arguments for entry-point petscVecCreate_World.");
        /* Call the API function. */
        petscVecCreate_World_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscVecCreate:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscVecCreate.");
