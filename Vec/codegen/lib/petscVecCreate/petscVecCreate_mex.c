...
static void __petscVecCreate_api(mxArray **plhs, const mxArray ** prhs) {
...
static void __petscVecCreate_World_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscVecCreate:TooManyOutputArguments",
                "Too many output arguments for entry-point petscVecCreate.\n");
        /* Call the API function. */
        __petscVecCreate_api(outputs, prhs);
    }
    else if (nrhs == 0) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscVecCreate_World:TooManyOutputArguments",
                "Too many output arguments for entry-point petscVecCreate_World.\n");
        /* Call the API function. */
        __petscVecCreate_World_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscVecCreate:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscVecCreate.");
