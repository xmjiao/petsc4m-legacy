...
static void __petscVecGetOwnershipRange_api(mxArray **plhs, const mxArray ** prhs) {
    struct0_T            vec;
    int32_T             *first_row;
    int32_T             *last_row;
    int32_T             *errCode;
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 4)
            mexErrMsgIdAndTxt("petscVecGetOwnershipRange:TooManyOutputArguments",
                "Too many output arguments for entry-point petscVecGetOwnershipRange.\n");
        /* Call the API function. */
        __petscVecGetOwnershipRange_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscVecGetOwnershipRange:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscVecGetOwnershipRange.");
