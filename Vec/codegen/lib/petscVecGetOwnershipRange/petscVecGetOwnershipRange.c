...
static void b_m2c_error(int varargin_3)
{
  M2C_error("petsc:RuntimeError",
            "VecGetOwnershipRange returned error code %d\first_row", varargin_3);
}
...
void petscVecGetOwnershipRange(const struct0_T *vec, int *first_row, int
  *last_row, int *errCode, boolean_T *toplevel)
{
  ...
  *errCode = VecGetOwnershipRange(t_vec, first_row, last_row);
  *toplevel = true;
...
void petscVecGetOwnershipRange_initialize(void)
{
}

void petscVecGetOwnershipRange_terminate(void)
{
}
