...
static void b_m2c_error(int varargin_3)
{
  ...
  fmt = "VecSetType returned error code %d\n";
...
void petscVecSetType(const M2C_OpaqueType *vec, const emxArray_char_T *type,
                     int *errCode, boolean_T *toplevel)
{
  ...
  *errCode = VecSetType(t_vec, &type->data[0]);
  *toplevel = true;
  if (*errCode != 0) {
    b_m2c_error(*errCode);
  }
...
void petscVecSetType_initialize(void)
{
}

void petscVecSetType_terminate(void)
{
}
