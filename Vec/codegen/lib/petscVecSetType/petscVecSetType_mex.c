...
static void __petscVecSetType_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 2) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscVecSetType:TooManyOutputArguments",
                "Too many output arguments for entry-point petscVecSetType.\n");
        /* Call the API function. */
        __petscVecSetType_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscVecSetType:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscVecSetType.");
