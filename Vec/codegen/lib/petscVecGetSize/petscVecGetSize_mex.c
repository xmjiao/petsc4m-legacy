...
static void __petscVecGetSize_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscVecGetSize:TooManyOutputArguments",
                "Too many output arguments for entry-point petscVecGetSize.\n");
        /* Call the API function. */
        __petscVecGetSize_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscVecGetSize:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscVecGetSize.");
