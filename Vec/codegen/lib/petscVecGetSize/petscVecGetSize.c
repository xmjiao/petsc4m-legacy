...
static void b_m2c_error(int varargin_3)
{
  ...
  fmt = "VecGetSize returned error code %d\n";
...
void petscVecGetSize(const struct0_T *vec, int *n, int *errCode, boolean_T
                     *toplevel)
{
  boolean_T p;
  boolean_T b_p;
...
void petscVecGetSize_initialize(void)
{
}

void petscVecGetSize_terminate(void)
{
}
