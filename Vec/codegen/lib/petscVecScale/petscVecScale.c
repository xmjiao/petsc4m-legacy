...
static void b_m2c_error(int varargin_3)
{
  ...
  fmt = "petscVecScale returned error code %d\n";
...
void petscVecScale_initialize(void)
{
}

void petscVecScale_terminate(void)
{
}
