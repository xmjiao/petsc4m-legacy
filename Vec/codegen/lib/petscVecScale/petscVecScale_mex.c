/*
 * Vec/codegen/lib/petscVecScale/petscVecScale_mex.c
 *
 * Auxiliary code for mexFunction of petscVecScale
 *
 * C source code generated by m2c.
 * %#m2c options:07efd959720a51d5ac42f7bdd51b81e4
 *
 */
...
static void __petscVecScale_api(mxArray **plhs, const mxArray ** prhs) {
    M2C_OpaqueType       v;
    real64_T             a;
    int32_T             *errCode;
    boolean_T           *toplevel;
    ...
    if (mxGetNumberOfElements(prhs[0]) && mxGetClassID(prhs[0]) != mxSTRUCT_CLASS)
        mexErrMsgIdAndTxt("petscVecScale:WrongInputType",
            "Input argument v has incorrect data type; struct is expected.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("petscVecScale:WrongSizeOfInputArg",
            "Argument v should be a scalar.");
    marshallin_M2C_OpaqueType(&v, prhs[0], "v");
    ...
    petscVecScale(&v, a, errCode, toplevel);

    /* Deallocate input and marshall out function outputs */
    plhs[0] = marshallout_M2C_OpaqueType(&v);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 2) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscVecScale:TooManyOutputArguments",
                "Too many output arguments for entry-point petscVecScale.\n");
        /* Call the API function. */
        __petscVecScale_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscVecScale:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscVecScale.");
