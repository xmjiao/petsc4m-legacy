 ...
 * %#m2c options: codegenArgs=-args {PetscVec, int32(0), coder.typeof(int32(0), [inf,1]), coder.typeof(0, [inf,1])} petscVecGetValues_Alloc -args {PetscVec, int32(0), coder.typeof(int32(0), [inf,1])}  enableInline=1
 *
 */
