...
static void b_m2c_error(int varargin_3)
{
  ...
  fmt = "VecSetOptions returned error code %d\n";
...
void petscVecSetOption(const M2C_OpaqueType *vec, int op, int flg, int *errCode,
                       boolean_T *toplevel)
{
  ...
  *errCode = VecSetOption(t_vec, op, flg);
  *toplevel = true;
  if (*errCode != 0) {
    b_m2c_error(*errCode);
  }
...
void petscVecSetOption_initialize(void)
{
}

void petscVecSetOption_terminate(void)
{
}
