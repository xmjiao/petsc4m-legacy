...
static void __petscVecSetOption_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 3) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscVecSetOption:TooManyOutputArguments",
                "Too many output arguments for entry-point petscVecSetOption.\n");
        /* Call the API function. */
        __petscVecSetOption_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscVecSetOption:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscVecSetOption.");
