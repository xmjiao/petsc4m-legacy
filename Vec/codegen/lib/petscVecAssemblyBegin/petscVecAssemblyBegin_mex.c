...
static void __petscVecAssemblyBegin_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscVecAssemblyBegin:TooManyOutputArguments",
                "Too many output arguments for entry-point petscVecAssemblyBegin.\n");
        /* Call the API function. */
        __petscVecAssemblyBegin_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscVecAssemblyBegin:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscVecAssemblyBegin.");
