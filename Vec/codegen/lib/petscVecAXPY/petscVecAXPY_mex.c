 ...
 * %#m2c options: codegenArgs=-args {PetscVec, 0, PetscVec}  enableInline=1 withPetsc=1
 *
 */
...
void petscVecAXPY_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[1], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscVecAXPY_initialize();

    petscVecAXPY(&y, a, &x, errCode, toplevel);

    petscVecAXPY_terminate();
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 3) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscVecAXPY:TooManyOutputArguments","Too many output arguments for entry-point petscVecAXPY.");
        /* Call the API function. */
        petscVecAXPY_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscVecAXPY:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscVecAXPY.");
