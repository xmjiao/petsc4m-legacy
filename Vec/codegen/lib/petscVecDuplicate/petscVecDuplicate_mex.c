...
static void __petscVecDuplicate_api(mxArray **plhs, const mxArray ** prhs) {
    M2C_OpaqueType       vec_in;
    M2C_OpaqueType       vec_out;
    int32_T             *errCode;
    boolean_T           *toplevel;
    ...
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("petscVecDuplicate:WrongSizeOfInputArg",
            "Argument vec_in should be a scalar.");
    marshallin_const_M2C_OpaqueType(&vec_in, prhs[0], "vec_in");
    prealloc_M2C_OpaqueType(&vec_out);
    ...
    destroy_M2C_OpaqueType(&vec_in);
    plhs[0] = marshallout_M2C_OpaqueType(&vec_out);
