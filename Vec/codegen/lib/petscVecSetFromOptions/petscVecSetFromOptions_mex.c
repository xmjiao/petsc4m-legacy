...
static void __petscVecSetFromOptions_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscVecSetFromOptions:TooManyOutputArguments",
                "Too many output arguments for entry-point petscVecSetFromOptions.\n");
        /* Call the API function. */
        __petscVecSetFromOptions_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscVecSetFromOptions:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscVecSetFromOptions.");
