#include "petscVecSetFromOptions.h"
#include "m2c.h"
#include "mpetsc.h"
...
static void b_m2c_error(int varargin_3)
{
  ...
  fmt = "VecSetFromOptions returned error code %d\n";
...
void petscVecSetFromOptions(const struct0_T *vec, int *errCode, boolean_T
  *toplevel)
{
  boolean_T p;
  boolean_T b_p;
...
void petscVecSetFromOptions_initialize(void)
{
}

void petscVecSetFromOptions_terminate(void)
{
}
