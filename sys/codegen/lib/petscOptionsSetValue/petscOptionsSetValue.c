...
void petscOptionsSetValue(const struct0_T *opts, const emxArray_char_T *iname,
  const emxArray_char_T *value, int *errCode, boolean_T *toplevel)
{
  boolean_T p;
  boolean_T b_p;
  int k;
  ...
  *errCode = PetscOptionsSetValue(c_opts, &iname->data[0], &value->data[0]);
  *toplevel = true;
