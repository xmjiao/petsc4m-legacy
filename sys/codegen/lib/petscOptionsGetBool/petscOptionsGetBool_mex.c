...
static void __petscOptionsGetBool_api(mxArray **plhs, const mxArray ** prhs) {
    emxArray_char_T      pre;
    ...
    value = (int32_T*)mxMalloc(sizeof(int32_T));
    ...
    plhs[0] = move_scalar_to_mxArray(value, mxINT32_CLASS);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 2) {
        if (nlhs > 4)
            mexErrMsgIdAndTxt("petscOptionsGetBool:TooManyOutputArguments",
                "Too many output arguments for entry-point petscOptionsGetBool.\n");
        /* Call the API function. */
        __petscOptionsGetBool_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscOptionsGetBool:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscOptionsGetBool.");
