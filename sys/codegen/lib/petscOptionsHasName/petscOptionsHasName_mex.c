 ...
 * %#m2c options:f4876e7f3c731492e4d769d3c0e154e7
 *
 */
...
static void __petscOptionsHasName_api(mxArray **plhs, const mxArray ** prhs) {
    ...
    marshallin_const_M2C_OpaqueType(&options, prhs[0], "options");
    ...
    destroy_M2C_OpaqueType(&options);
