...
static void __petscOptionsInsertFile_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 3) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscOptionsInsertFile:TooManyOutputArguments",
                "Too many output arguments for entry-point petscOptionsInsertFile.\n");
        /* Call the API function. */
        __petscOptionsInsertFile_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscOptionsInsertFile:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscOptionsInsertFile.");
