...
%    setup and solve.
%
% SEE ALSO: bicgstabHypre, gmresPetsc, petscSolve
...
if nargin >= next_index + 5 && ~isempty(varargin{next_index + 5})
    ...
    opts = [opts ' -pc_hypre_boomeramg_coarsen_type HMIS'];
end
...
%!test
%!shared A, b
%! system('gd-get -O DataRepository/Matrices/test_matrices_lired/FL/fem2d"*".mat');
%! s = load('fem2d_cd.mat');
%! A = s.A;
