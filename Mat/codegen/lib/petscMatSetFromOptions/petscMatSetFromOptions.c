#include "petscMatSetFromOptions.h"
#include "m2c.h"
#include "mpetsc.h"
...
static void b_m2c_error(int varargin_3)
{
  ...
  fmt = "MatSetFromOptions returned error code %d\n";
...
void petscMatSetFromOptions(const struct0_T *mat, int *errCode, boolean_T
  *toplevel)
{
  boolean_T p;
  boolean_T b_p;
...
void petscMatSetFromOptions_initialize(void)
{
}

void petscMatSetFromOptions_terminate(void)
{
}
