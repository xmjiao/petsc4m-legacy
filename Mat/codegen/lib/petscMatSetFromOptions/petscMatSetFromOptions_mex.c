...
static void __petscMatSetFromOptions_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscMatSetFromOptions:TooManyOutputArguments",
                "Too many output arguments for entry-point petscMatSetFromOptions.\n");
        /* Call the API function. */
        __petscMatSetFromOptions_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscMatSetFromOptions:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscMatSetFromOptions.");
