 ...
 * %#m2c options: codegenArgs=-args {PetscMat, PetscVec, PetscVec, PetscVec} enableInline=1 presVars=None dynMem=Threshold
 *
 */
...
void petscMatMultTransposeAdd_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void**)&v1.data = mxCalloc(1, sizeof(emxArray__common));
    ...
    if (mxGetNumberOfElements(_sub_mx1) && mxGetDimensions(_sub_mx1)[0] != 1)
        mexErrMsgIdAndTxt("petscMatMultTransposeAdd:WrongSizeOfInputArg",
            "Dimension 1 of v1.type should be equal to 1.");
    ...
    *(void**)&v2.data = mxCalloc(1, sizeof(emxArray__common));
    ...
    if (mxGetNumberOfElements(_sub_mx1) && mxGetDimensions(_sub_mx1)[0] != 1)
        mexErrMsgIdAndTxt("petscMatMultTransposeAdd:WrongSizeOfInputArg",
            "Dimension 1 of v2.type should be equal to 1.");
    ...
    *(void**)&v3.data = mxCalloc(1, sizeof(emxArray__common));
    ...
    if (mxGetNumberOfElements(_sub_mx1) && mxGetDimensions(_sub_mx1)[0] != 1)
        mexErrMsgIdAndTxt("petscMatMultTransposeAdd:WrongSizeOfInputArg",
            "Dimension 1 of v3.type should be equal to 1.");
