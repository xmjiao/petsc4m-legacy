...
static void b_m2c_error(int varargin_3)
{
  ...
  fmt = "MatAssembled returned error code %d\n";
...
void petscMatAssembled(const M2C_OpaqueType *mat, int *assembled, int *errCode,
                       boolean_T *toplevel)
{
...
void petscMatAssembled_initialize(void)
{
}

void petscMatAssembled_terminate(void)
{
}
