...
static void b_m2c_error(int varargin_3)
{
  M2C_error("petsc:RuntimeError",
            "MatGetTransposeNullSpace returned error code %d\n", varargin_3);
}
...
void petscMatGetTransposeNullSpace(const struct0_T *mat, struct0_T *nullsp, int *
  errCode, boolean_T *toplevel)
{
  ...
  *errCode = MatGetTransposeNullSpace(c_mat, &t_nullsp);
  *toplevel = true;
