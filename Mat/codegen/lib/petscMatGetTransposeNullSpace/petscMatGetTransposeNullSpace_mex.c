...
static void __petscMatGetTransposeNullSpace_api(mxArray **plhs, const mxArray ** prhs) {
    M2C_OpaqueType       mat;
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscMatGetTransposeNullSpace:TooManyOutputArguments",
                "Too many output arguments for entry-point petscMatGetTransposeNullSpace.\n");
        /* Call the API function. */
        __petscMatGetTransposeNullSpace_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscMatGetTransposeNullSpace:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscMatGetTransposeNullSpace.");
