...
static void __petscMatConvert_api(mxArray **plhs, const mxArray ** prhs) {
    ...
    marshallin_const_struct0_T(&mat_in, prhs[0], "mat_in");
    ...
    if (mxGetNumberOfElements(prhs[1]) && mxGetDimensions(prhs[1])[0] != 1) 
        mexErrMsgIdAndTxt("petscMatConvert:WrongSizeOfInputArg",
            "Dimension 1 of newtype should equal 1.");
