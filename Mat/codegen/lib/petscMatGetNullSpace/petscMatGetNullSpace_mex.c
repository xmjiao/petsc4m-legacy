...
void petscMatGetNullSpace_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[2], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscMatGetNullSpace_initialize();

    petscMatGetNullSpace(&mat, &nullsp, errCode, toplevel);

    petscMatGetNullSpace_terminate();
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscMatGetNullSpace:TooManyOutputArguments","Too many output arguments for entry-point petscMatGetNullSpace.");
        /* Call the API function. */
        petscMatGetNullSpace_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscMatGetNullSpace:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscMatGetNullSpace.");
