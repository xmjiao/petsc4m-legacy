...
static void b_m2c_error(int varargin_3)
{
  ...
  fmt = "MatGetNullSpace returned error code %d\n";
...
void petscMatGetNullSpace(const struct0_T *mat, struct0_T *nullsp, int *errCode,
  boolean_T *toplevel)
{
  ...
  *errCode = MatGetNullSpace(c_mat, &t_nullsp);
  *toplevel = true;
...
void petscMatGetNullSpace_initialize(void)
{
}

void petscMatGetNullSpace_terminate(void)
{
}
