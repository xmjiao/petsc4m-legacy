...
static void __petscMatSetType_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 2) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscMatSetType:TooManyOutputArguments",
                "Too many output arguments for entry-point petscMatSetType.\n");
        /* Call the API function. */
        __petscMatSetType_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscMatSetType:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscMatSetType.");
