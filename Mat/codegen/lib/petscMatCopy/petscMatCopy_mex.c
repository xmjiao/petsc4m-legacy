 ...
 * %#m2c options: codegenArgs=-args {PetscMat, PetscMat, int32(0)} petscMatCopy_2args -args {PetscMat, PetscMat} enableInline=1 presVars=None dynMem=Threshold
 *
 */
...
static void __petscMatCopy_api(mxArray **plhs, const mxArray ** prhs) {
...
static void __petscMatCopy_2args_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 3) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscMatCopy:TooManyOutputArguments",
                "Too many output arguments for entry-point petscMatCopy.\n");
        /* Call the API function. */
        __petscMatCopy_api(outputs, prhs);
    }
    else if (nrhs == 2) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscMatCopy_2args:TooManyOutputArguments",
                "Too many output arguments for entry-point petscMatCopy_2args.\n");
        /* Call the API function. */
        __petscMatCopy_2args_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscMatCopy:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscMatCopy.");
