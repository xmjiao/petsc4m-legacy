...
void petscMatSetOption_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[1], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscMatSetOption_initialize();

    petscMatSetOption(&mat, op, flg, errCode, toplevel);

    petscMatSetOption_terminate();
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 3) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscMatSetOption:TooManyOutputArguments","Too many output arguments for entry-point petscMatSetOption.");
        /* Call the API function. */
        petscMatSetOption_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscMatSetOption:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscMatSetOption.");
