...
static void __petscMatMultHermitianTranspose_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 3) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscMatMultHermitianTranspose:TooManyOutputArguments",
                "Too many output arguments for entry-point petscMatMultHermitianTranspose.\n");
        /* Call the API function. */
        __petscMatMultHermitianTranspose_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscMatMultHermitianTranspose:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscMatMultHermitianTranspose.");
