...
static void __petscMatSetTransposeNullSpace_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 2) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscMatSetTransposeNullSpace:TooManyOutputArguments",
                "Too many output arguments for entry-point petscMatSetTransposeNullSpace.\n");
        /* Call the API function. */
        __petscMatSetTransposeNullSpace_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscMatSetTransposeNullSpace:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscMatSetTransposeNullSpace.");
