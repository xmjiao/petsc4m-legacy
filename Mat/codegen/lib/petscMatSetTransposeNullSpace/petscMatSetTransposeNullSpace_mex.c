/*
 * Mat/codegen/lib/petscMatSetTransposeNullSpace/petscMatSetTransposeNullSpace_mex.c
 *
 * Auxiliary code for mexFunction of petscMatSetTransposeNullSpace
 *
 * C source code generated by m2c.
 * %#m2c options: codegenArgs=-args {PetscMat, PetscMatNullSpace}  enableInline=1 withPetsc=1
 *
 */
...
void petscMatSetTransposeNullSpace_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    if (!mxIsStruct(prhs[0]))
        mexErrMsgIdAndTxt("petscMatSetTransposeNullSpace:WrongInputType",
            "Input argument mat has incorrect data type. struct is expected.");
    if (mxGetNumberOfFields(prhs[0])!=3)
        mexErrMsgIdAndTxt("petscMatSetTransposeNullSpace:InputStructWrongFields",
            "Input argument mat has incorrect number of fields.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("petscMatSetTransposeNullSpace:WrongSizeOfInputArg",
            "Argument mat must contain 1 items.");

    _sub_mx1 = mxGetField(prhs[0], 0, "data");
    if (_sub_mx1==NULL)
        mexErrMsgIdAndTxt("petscMatSetTransposeNullSpace:WrongInputStruct",
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[1], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscMatSetTransposeNullSpace_initialize();

    petscMatSetTransposeNullSpace(&mat, &nullSp, errCode, toplevel);

    petscMatSetTransposeNullSpace_terminate();
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 2) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscMatSetTransposeNullSpace:TooManyOutputArguments","Too many output arguments for entry-point petscMatSetTransposeNullSpace.");
        /* Call the API function. */
        petscMatSetTransposeNullSpace_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscMatSetTransposeNullSpace:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscMatSetTransposeNullSpace.");
