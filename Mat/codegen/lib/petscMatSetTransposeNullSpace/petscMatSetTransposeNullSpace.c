#include "petscMatSetTransposeNullSpace.h"
#include "m2c.h"
#include "petsc4m.h"
...
static void c_m2c_error(int varargin_3)
{
  ...
  fmt = "MatSetTransposeNullSpace returned error code %d\n";
...
void petscMatSetTransposeNullSpace(const struct0_T *mat, const struct0_T *nullSp,
  int *errCode, boolean_T *toplevel)
{
  ...
  *errCode = MatSetTransposeNullSpace(t_mat, t_nullSp);
  *toplevel = true;
...
void petscMatSetTransposeNullSpace_initialize(void)
{
}

void petscMatSetTransposeNullSpace_terminate(void)
{
}
