...
static void __petscMatSeqAIJSetPreallocationCSR_api(mxArray **plhs, const mxArray ** prhs) {
...
static void __petscMatSeqAIJSetPreallocationCSR_Indexonly_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 4) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscMatSeqAIJSetPreallocationCSR:TooManyOutputArguments",
                "Too many output arguments for entry-point petscMatSeqAIJSetPreallocationCSR.\n");
        /* Call the API function. */
        __petscMatSeqAIJSetPreallocationCSR_api(outputs, prhs);
    }
    else if (nrhs == 3) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscMatSeqAIJSetPreallocationCSR_Indexonly:TooManyOutputArguments",
                "Too many output arguments for entry-point petscMatSeqAIJSetPreallocationCSR_Indexonly.\n");
        /* Call the API function. */
        __petscMatSeqAIJSetPreallocationCSR_Indexonly_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscMatSeqAIJSetPreallocationCSR:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscMatSeqAIJSetPreallocationCSR.");
