/*
 * Mat/codegen/lib/petscMatSeqAIJSetPreallocationCSR/petscMatSeqAIJSetPreallocationCSR_mex.c
 *
 * Auxiliary code for mexFunction of petscMatSeqAIJSetPreallocationCSR
 *
 * C source code generated by m2c.
 * %#m2c options: codegenArgs=-args {PetscMat, coder.typeof(int32(0), [inf,1]), coder.typeof(int32(0), [inf,1]), coder.typeof(0, [inf,1])} petscMatSeqAIJSetPreallocationCSR_Indexonly -args {PetscMat, coder.typeof(int32(0), [inf,1]), coder.typeof(int32(0), [inf,1])} enableInline=1 presVars=None dynMem=Threshold
 *
 */
...
void petscMatSeqAIJSetPreallocationCSR_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    if (!mxIsStruct(prhs[0]))
        mexErrMsgIdAndTxt("petscMatSeqAIJSetPreallocationCSR:WrongInputType",
            "Input argument mat has incorrect data type. struct is expected.");
    if (mxGetNumberOfFields(prhs[0])!=3)
        mexErrMsgIdAndTxt("petscMatSeqAIJSetPreallocationCSR:InputStructWrongFields",
            "Input argument mat has incorrect number of fields.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("petscMatSeqAIJSetPreallocationCSR:WrongSizeOfInputArg",
            "Argument mat must contain 1 items.");

    _sub_mx1 = mxGetField(prhs[0], 0, "data");
    if (_sub_mx1==NULL)
        mexErrMsgIdAndTxt("petscMatSeqAIJSetPreallocationCSR:WrongInputStruct",
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[1], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscMatSeqAIJSetPreallocationCSR_initialize();

    petscMatSeqAIJSetPreallocationCSR(&mat, &ix, &jx, &vs, errCode, toplevel);

    petscMatSeqAIJSetPreallocationCSR_terminate();
...
void petscMatSeqAIJSetPreallocationCSR_Indexonly_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    if (!mxIsStruct(prhs[0]))
        mexErrMsgIdAndTxt("petscMatSeqAIJSetPreallocationCSR_Indexonly:WrongInputType",
            "Input argument mat has incorrect data type. struct is expected.");
    if (mxGetNumberOfFields(prhs[0])!=3)
        mexErrMsgIdAndTxt("petscMatSeqAIJSetPreallocationCSR_Indexonly:InputStructWrongFields",
            "Input argument mat has incorrect number of fields.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("petscMatSeqAIJSetPreallocationCSR_Indexonly:WrongSizeOfInputArg",
            "Argument mat must contain 1 items.");

    _sub_mx1 = mxGetField(prhs[0], 0, "data");
    if (_sub_mx1==NULL)
        mexErrMsgIdAndTxt("petscMatSeqAIJSetPreallocationCSR_Indexonly:WrongInputStruct",
            "Input argument mat does not have the field data.");
    if (mxGetNumberOfElements(_sub_mx1) && mxGetClassID(_sub_mx1) != mxUINT8_CLASS)
        mexErrMsgIdAndTxt("petscMatSeqAIJSetPreallocationCSR_Indexonly:WrongInputType",
            "Input argument mat.data has incorrect data type. uint8 is expected.");
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[1], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscMatSeqAIJSetPreallocationCSR_Indexonly(&mat, &ix, &jx, errCode, toplevel);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 4) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscMatSeqAIJSetPreallocationCSR:TooManyOutputArguments","Too many output arguments for entry-point petscMatSeqAIJSetPreallocationCSR.");
        /* Call the API function. */
        petscMatSeqAIJSetPreallocationCSR_api(prhs, (const mxArray**)outputs);
    }
    else if (nrhs == 3) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscMatSeqAIJSetPreallocationCSR_Indexonly:TooManyOutputArguments","Too many output arguments for entry-point petscMatSeqAIJSetPreallocationCSR_Indexonly.");
        /* Call the API function. */
        petscMatSeqAIJSetPreallocationCSR_Indexonly_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscMatSeqAIJSetPreallocationCSR:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscMatSeqAIJSetPreallocationCSR.");
