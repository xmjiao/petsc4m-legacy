 ...
 * %#m2c options: codegenArgs=-args {PetscMat, coder.typeof(int32(0), [inf,1]), coder.typeof(int32(0), [inf,1]), coder.typeof(0, [inf,1])} petscMatSeqAIJSetPreallocationCSR_Indexonly -args {PetscMat, coder.typeof(int32(0), [inf,1]), coder.typeof(int32(0), [inf,1])}  enableInline=1
 *
 */
