...
void petscMatSetSizes_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[1], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscMatSetSizes_initialize();

    petscMatSetSizes(&mat, m, n, M, N, errCode, toplevel);

    petscMatSetSizes_terminate();
...
void petscMatSetSizes_Local_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void**)&mat.type = mxCalloc(1, sizeof(emxArray__common));
    ...
    errCode = petscMatSetSizes_Local(&mat, m, n);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 5) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscMatSetSizes:TooManyOutputArguments","Too many output arguments for entry-point petscMatSetSizes.");
        /* Call the API function. */
        petscMatSetSizes_api(prhs, (const mxArray**)outputs);
    }
    else if (nrhs == 3) {
        if (nlhs > 1)
            mexErrMsgIdAndTxt("petscMatSetSizes_Local:TooManyOutputArguments","Too many output arguments for entry-point petscMatSetSizes_Local.");
        /* Call the API function. */
        petscMatSetSizes_Local_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscMatSetSizes:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscMatSetSizes.");
