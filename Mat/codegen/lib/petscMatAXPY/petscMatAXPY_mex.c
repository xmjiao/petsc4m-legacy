...
void petscMatAXPY_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[1], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscMatAXPY_initialize();

    petscMatAXPY(&Y, a, &X, mstr, errCode, toplevel);

    petscMatAXPY_terminate();
...
void petscMatAXPY_3args_api(const mxArray ** prhs, const mxArray **plhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 4) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscMatAXPY:TooManyOutputArguments","Too many output arguments for entry-point petscMatAXPY.");
        /* Call the API function. */
        petscMatAXPY_api(prhs, (const mxArray**)outputs);
    }
    else if (nrhs == 3) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscMatAXPY_3args:TooManyOutputArguments","Too many output arguments for entry-point petscMatAXPY_3args.");
        /* Call the API function. */
        petscMatAXPY_3args_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscMatAXPY:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscMatAXPY.");
