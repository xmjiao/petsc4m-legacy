...
static void __petscMatGetOwnershipRange_api(mxArray **plhs, const mxArray ** prhs) {
    M2C_OpaqueType       mat;
    int32_T             *first_row;
    int32_T             *last_row;
    int32_T             *errCode;
    ...
    first_row = (int32_T*)mxMalloc(sizeof(int32_T));

    last_row = (int32_T*)mxMalloc(sizeof(int32_T));
    ...
    plhs[0] = move_scalar_to_mxArray(first_row, mxINT32_CLASS);
    plhs[1] = move_scalar_to_mxArray(last_row, mxINT32_CLASS);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 4)
            mexErrMsgIdAndTxt("petscMatGetOwnershipRange:TooManyOutputArguments",
                "Too many output arguments for entry-point petscMatGetOwnershipRange.\n");
        /* Call the API function. */
        __petscMatGetOwnershipRange_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscMatGetOwnershipRange:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscMatGetOwnershipRange.");
