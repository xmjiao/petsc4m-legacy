...
static void b_m2c_error(int varargin_3)
{
  ...
  fmt = "petscMatScale returned error code %d\n";
...
void petscMatScale(const M2C_OpaqueType *mat, double a, int *errCode,
                   boolean_T *toplevel)
{
...
void petscMatScale_initialize(void)
{
}

void petscMatScale_terminate(void)
{
}
