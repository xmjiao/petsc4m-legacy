...
static void __petscMatSetOptionsPrefix_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 2) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscMatSetOptionsPrefix:TooManyOutputArguments",
                "Too many output arguments for entry-point petscMatSetOptionsPrefix.\n");
        /* Call the API function. */
        __petscMatSetOptionsPrefix_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscMatSetOptionsPrefix:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscMatSetOptionsPrefix.");
