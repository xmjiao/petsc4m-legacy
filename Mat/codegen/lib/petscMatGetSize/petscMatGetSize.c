...
static void b_m2c_error(int varargin_3)
{
  ...
  fmt = "MatGetSize returned error code %d\n";
...
void petscMatGetSize(const M2C_OpaqueType *mat, int *m, int *n, int *errCode,
                     boolean_T *toplevel)
{
...
void petscMatGetSize_initialize(void)
{
}

void petscMatGetSize_terminate(void)
{
}
