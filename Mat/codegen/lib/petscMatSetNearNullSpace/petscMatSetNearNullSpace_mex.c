...
static void __petscMatSetNearNullSpace_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 2) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscMatSetNearNullSpace:TooManyOutputArguments",
                "Too many output arguments for entry-point petscMatSetNearNullSpace.\n");
        /* Call the API function. */
        __petscMatSetNearNullSpace_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscMatSetNearNullSpace:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscMatSetNearNullSpace.");
