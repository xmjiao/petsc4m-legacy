/*
 * Mat/codegen/lib/petscMatMult/petscMatMult_mex.c
 *
 * Auxiliary code for mexFunction of petscMatMult
 *
...
void petscMatMult_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[1], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscMatMult_initialize();

    petscMatMult(&A, &x, &y, errCode, toplevel);

    petscMatMult_terminate();
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 3) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscMatMult:TooManyOutputArguments","Too many output arguments for entry-point petscMatMult.");
        /* Call the API function. */
        petscMatMult_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscMatMult:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscMatMult.");
