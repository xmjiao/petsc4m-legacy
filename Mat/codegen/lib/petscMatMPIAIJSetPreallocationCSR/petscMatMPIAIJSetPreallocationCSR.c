...
static void b_m2c_error(int varargin_3)
{
  M2C_error("petsc:RuntimeError",
            "MatMPIAIJSetPreallocationCSR returned error code %d\n", varargin_3);
}
...
void petscMatMPIAIJSetPreallocationCSR(const struct0_T *mat, const
...
void petscMatMPIAIJSetPreallocationCSR_Indexonly(const struct0_T *mat, const
