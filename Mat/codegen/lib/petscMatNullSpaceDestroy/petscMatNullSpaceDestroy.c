  ...
  *toplevel)
{
  ...
  if (!p) {
    ...
    emxEnsureCapacity((emxArray__common *)b_matNull, k, sizeof(char));
  ...
  *toplevel = true;
  ...
  emxEnsureCapacity((emxArray__common *)matNull->data, k, sizeof(unsigned char));
  ...
  emxEnsureCapacity((emxArray__common *)matNull->type, k, sizeof(char));
  for (k = 0; k < 12; k++) {
