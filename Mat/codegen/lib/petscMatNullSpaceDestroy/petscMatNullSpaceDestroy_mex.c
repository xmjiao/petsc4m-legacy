 ...
 * %#m2c options:cb29b9df6d7d87f60686e68c455e7df1
 *
 */
...
static void __petscMatNullSpaceDestroy_api(mxArray **plhs, const mxArray ** prhs) {
    ...
    marshallin_M2C_OpaqueType(&matNull, prhs[0], "matNull");
    ...
    plhs[0] = marshallout_M2C_OpaqueType(&matNull);
