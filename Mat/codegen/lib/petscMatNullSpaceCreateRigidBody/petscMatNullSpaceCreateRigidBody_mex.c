...
static void __petscMatNullSpaceCreateRigidBody_api(mxArray **plhs, const mxArray ** prhs) {
    ...
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("petscMatNullSpaceCreateRigidBody:WrongSizeOfInputArg",
            "Argument coords should be a scalar.");
    marshallin_const_M2C_OpaqueType(&coords, prhs[0], "coords");
    prealloc_M2C_OpaqueType(&nullsp);
    ...
    destroy_M2C_OpaqueType(&coords);
    plhs[0] = marshallout_M2C_OpaqueType(&nullsp);
