 ...
 * %#m2c options: codegenArgs=-args {int32(0), int32(0), int32(0), coder.typeof(int32(0), [inf,1])} petscMatCreateSeqAIJ_FixedRows -args {int32(0), int32(0), int32(0)}  enableInline=1
 *
 */
