...
static void __petscMatGetNearNullSpace_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscMatGetNearNullSpace:TooManyOutputArguments",
                "Too many output arguments for entry-point petscMatGetNearNullSpace.\n");
        /* Call the API function. */
        __petscMatGetNearNullSpace_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscMatGetNearNullSpace:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscMatGetNearNullSpace.");
