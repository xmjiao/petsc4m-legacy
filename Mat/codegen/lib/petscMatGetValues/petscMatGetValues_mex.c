 ...
 * %#m2c options: codegenArgs=-args {PetscMat, int32(0), coder.typeof(int32(0), [inf,1]), int32(0), coder.typeof(int32(0), [inf,1]), coder.typeof(0, [inf,1])} petscMatGetValues_Alloc -args {PetscMat, int32(0), coder.typeof(int32(0), [inf,1]), int32(0), coder.typeof(int32(0), [inf,1])} enableInline=1 presVars=None dynMem=Threshold
 *
 */
...
void petscMatGetValues_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void**)&mat.type = mxCalloc(1, sizeof(emxArray__common));
    ...
    petscMatGetValues(&mat, ni, &ix, nj, &jx, &v);

    petscMatGetValues_terminate();

    /* Marshall out function outputs */
    if (v.canFreeData) plhs[0] = move_emxArray_to_mxArray((emxArray__common*)&v, mxDOUBLE_CLASS);
    /* Creating empty mxArray for pruned variable errCode */
    {mwSize l_size[] = {1, 1};
    prealloc_mxArray((mxArray**)&plhs[1], mxINT32_CLASS, 2, l_size); }
