...
void mpi_Comm_size(const struct0_T *comm, int *size, int *info, boolean_T
                   *toplevel)
{
  boolean_T p;
  boolean_T b_p;
  ...
  *info = MPI_Comm_size(c_comm, size);
  *toplevel = true;
...
void mpi_Comm_size_initialize(void)
{
}

void mpi_Comm_size_terminate(void)
{
}
