...
static void __petscPCApplyTranspose_api(mxArray **plhs, const mxArray ** prhs) {
...
static void __petscPCApplyTranspose_2args_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 3) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscPCApplyTranspose:TooManyOutputArguments",
                "Too many output arguments for entry-point petscPCApplyTranspose.\n");
        /* Call the API function. */
        __petscPCApplyTranspose_api(outputs, prhs);
    }
    else if (nrhs == 2) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscPCApplyTranspose_2args:TooManyOutputArguments",
                "Too many output arguments for entry-point petscPCApplyTranspose_2args.\n");
        /* Call the API function. */
        __petscPCApplyTranspose_2args_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscPCApplyTranspose:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscPCApplyTranspose.");
