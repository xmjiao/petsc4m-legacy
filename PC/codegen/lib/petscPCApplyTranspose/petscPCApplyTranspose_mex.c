 ...
 * %#m2c options: codegenArgs=-args {PetscPC, PetscVec, PetscVec} petscPCApplyTranspose_2args -args {PetscPC, PetscVec} enableInline=1 presVars=None dynMem=Threshold
 *
 */
