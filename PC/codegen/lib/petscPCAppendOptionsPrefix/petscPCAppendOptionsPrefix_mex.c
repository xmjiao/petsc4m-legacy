/*
 * PC/codegen/lib/petscPCAppendOptionsPrefix/petscPCAppendOptionsPrefix_mex.c
 *
 * Auxiliary code for mexFunction of petscPCAppendOptionsPrefix
 *
 * C source code generated by m2c.
 * %#m2c options: codegenArgs=-args {PetscPC, coder.typeof(char(0), [1, inf])} enableInline=1 presVars=None dynMem=Threshold
 *
 */
