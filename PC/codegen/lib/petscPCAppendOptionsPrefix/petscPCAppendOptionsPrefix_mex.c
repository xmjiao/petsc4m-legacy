...
static void __petscPCAppendOptionsPrefix_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 2) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscPCAppendOptionsPrefix:TooManyOutputArguments",
                "Too many output arguments for entry-point petscPCAppendOptionsPrefix.\n");
        /* Call the API function. */
        __petscPCAppendOptionsPrefix_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscPCAppendOptionsPrefix:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscPCAppendOptionsPrefix.");
