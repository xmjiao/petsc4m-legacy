...
static void __petscPCFactorGetMatrix_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscPCFactorGetMatrix:TooManyOutputArguments",
                "Too many output arguments for entry-point petscPCFactorGetMatrix.\n");
        /* Call the API function. */
        __petscPCFactorGetMatrix_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscPCFactorGetMatrix:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscPCFactorGetMatrix.");
