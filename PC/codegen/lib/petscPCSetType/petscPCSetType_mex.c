...
static void __petscPCSetType_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 2) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscPCSetType:TooManyOutputArguments",
                "Too many output arguments for entry-point petscPCSetType.\n");
        /* Call the API function. */
        __petscPCSetType_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscPCSetType:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscPCSetType.");
