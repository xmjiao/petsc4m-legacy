 ...
 * %#m2c options: codegenArgs=-args {PetscPC, PetscMat, PetscMat} petscPCSetOperators_AforP -args {PetscPC, PetscMat} enableInline=1 presVars=None dynMem=Threshold
 *
 */
...
void petscPCSetOperators_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    if (mxGetNumberOfFields(prhs[0])!=3)
        mexErrMsgIdAndTxt("petscPCSetOperators:InputStructWrongFields",
    ...
    if (_sub_mx1==NULL)
        mexErrMsgIdAndTxt("petscPCSetOperators:WrongInputStruct",
    ...
    *(void**)&Amat.data = mxCalloc(1, sizeof(emxArray__common));
    ...
    if (mxGetNumberOfElements(_sub_mx1) && mxGetDimensions(_sub_mx1)[0] != 1)
        mexErrMsgIdAndTxt("petscPCSetOperators:WrongSizeOfInputArg",
            "Dimension 1 of Amat.type should be equal to 1.");
    ...
    *(void**)&Pmat.data = mxCalloc(1, sizeof(emxArray__common));
    ...
    if (mxGetNumberOfElements(_sub_mx1) && mxGetDimensions(_sub_mx1)[0] != 1)
        mexErrMsgIdAndTxt("petscPCSetOperators:WrongSizeOfInputArg",
            "Dimension 1 of Pmat.type should be equal to 1.");
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[1], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscPCSetOperators_initialize();

    petscPCSetOperators(&pc, &Amat, &Pmat, errCode, toplevel);

    petscPCSetOperators_terminate();
...
void petscPCSetOperators_AforP_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    if (mxGetNumberOfFields(prhs[0])!=3)
        mexErrMsgIdAndTxt("petscPCSetOperators_AforP:InputStructWrongFields",
    ...
    _sub_mx1 = mxGetField(prhs[0], 0, "data");
    if (_sub_mx1==NULL)
        mexErrMsgIdAndTxt("petscPCSetOperators_AforP:WrongInputStruct",
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 3) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscPCSetOperators:TooManyOutputArguments","Too many output arguments for entry-point petscPCSetOperators.");
        /* Call the API function. */
        petscPCSetOperators_api(prhs, (const mxArray**)outputs);
    }
    else if (nrhs == 2) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscPCSetOperators_AforP:TooManyOutputArguments","Too many output arguments for entry-point petscPCSetOperators_AforP.");
        /* Call the API function. */
        petscPCSetOperators_AforP_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscPCSetOperators:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscPCSetOperators.");
