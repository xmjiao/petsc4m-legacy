...
static void __petscPCFactorSetMatSolverPackage_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 2) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscPCFactorSetMatSolverPackage:TooManyOutputArguments",
                "Too many output arguments for entry-point petscPCFactorSetMatSolverPackage.\n");
        /* Call the API function. */
        __petscPCFactorSetMatSolverPackage_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscPCFactorSetMatSolverPackage:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscPCFactorSetMatSolverPackage.");
