...
static void __petscPCGetOptionsPrefix_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscPCGetOptionsPrefix:TooManyOutputArguments",
                "Too many output arguments for entry-point petscPCGetOptionsPrefix.\n");
        /* Call the API function. */
        __petscPCGetOptionsPrefix_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscPCGetOptionsPrefix:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscPCGetOptionsPrefix.");
