 ...
 * %#m2c options:b879238b7448ae89a01b57238d54ee30
 *
 */
...
static void __petscPCApply_api(mxArray **plhs, const mxArray ** prhs) {
    M2C_OpaqueType       pc;
    M2C_OpaqueType       b;
    M2C_OpaqueType       x;
    int32_T             *errCode;
...
static void __petscPCApply_2args_api(mxArray **plhs, const mxArray ** prhs) {
    M2C_OpaqueType       ksp;
    M2C_OpaqueType       b;
    int32_T             *errCode;
    boolean_T           *toplevel;
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 3) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscPCApply:TooManyOutputArguments",
                "Too many output arguments for entry-point petscPCApply.\n");
        /* Call the API function. */
        __petscPCApply_api(outputs, prhs);
    }
    else if (nrhs == 2) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscPCApply_2args:TooManyOutputArguments",
                "Too many output arguments for entry-point petscPCApply_2args.\n");
        /* Call the API function. */
        __petscPCApply_2args_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscPCApply:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscPCApply.");
