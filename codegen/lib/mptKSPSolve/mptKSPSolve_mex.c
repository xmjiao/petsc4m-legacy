 ...
 * %#m2c options: codegenArgs=-args {PetscKSP, PetscVec, PetscVec, 0, int32(0), PetscVec} mptKSPSolve_2args -args {PetscKSP, PetscVec} mptKSPSolve_3args -args {PetscKSP, PetscVec, PetscVec} mptKSPSolve_4args -args {PetscKSP, PetscVec, PetscVec, 0} mptKSPSolve_5args -args {PetscKSP, PetscVec, PetscVec, 0, int32(0)}  enableInline=1 withPetsc=1
 *
 */
