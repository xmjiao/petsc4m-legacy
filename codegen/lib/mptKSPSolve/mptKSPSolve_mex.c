 ...
 * %#m2c options: codegenArgs=-args {PetscKSP, PetscVec, PetscVec, 0, int32(0), PetscVec} mptKSPSolve_2args -args {PetscKSP, PetscVec} mptKSPSolve_3args -args {PetscKSP, PetscVec, PetscVec} mptKSPSolve_4args -args {PetscKSP, PetscVec, PetscVec, 0} mptKSPSolve_5args -args {PetscKSP, PetscVec, PetscVec, 0, int32(0)} enableInline=1 presVars=None dynMem=AllVariableSizeArrays
 *
 */
...
void mptKSPSolve_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void**)&x0.data = mxCalloc(1, sizeof(emxArray__common));
    ...
    if (mxGetNumberOfElements(_sub_mx1) && mxGetDimensions(_sub_mx1)[0] != 1)
        mexErrMsgIdAndTxt("mptKSPSolve:WrongSizeOfInputArg",
            "Dimension 1 of x0.type should be equal to 1.");
