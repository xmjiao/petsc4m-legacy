 ...
 * %#m2c options: codegenArgs=-args {PetscKSP, PetscVec, PetscVec, 0, int32(0)} mptKSPSolve_2args -args {PetscKSP, PetscVec} mptKSPSolve_3args -args {PetscKSP, PetscVec, PetscVec} mptKSPSolve_4args -args {PetscKSP, PetscVec, PetscVec, 0} mptKSPSolve_6args -args {PetscKSP, PetscVec, PetscVec, 0, int32(0), PetscVec} mptKSPSolve_7args -args {PetscKSP, PetscVec, PetscVec, 0, int32(0), PetscVec, PetscVec}  enableInline=1 timing={''} withPetsc=1
 *
 */
...
void mptKSPSolve_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&iter = prealloc_mxArray((mxArray**)&plhs[2], mxINT32_CLASS, 2, l_size); }
    ...
    mptKSPSolve(&ksp, &b, &x, rtol, maxit, flag, relres, iter);

    _timestamp = M2C_wtime() - _timestamp;
    printf("Function mptKSPSolve completed in %g seconds.\n", _timestamp);
...
void mptKSPSolve_2args_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&iter = prealloc_mxArray((mxArray**)&plhs[2], mxINT32_CLASS, 2, l_size); }
    ...
    mptKSPSolve_2args(&ksp, &b, flag, relres, iter);

    _timestamp = M2C_wtime() - _timestamp;
    printf("Function mptKSPSolve_2args completed in %g seconds.\n", _timestamp);
...
void mptKSPSolve_3args_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&iter = prealloc_mxArray((mxArray**)&plhs[2], mxINT32_CLASS, 2, l_size); }
    ...
    mptKSPSolve_3args(&ksp, &b, &x, flag, relres, iter);

    _timestamp = M2C_wtime() - _timestamp;
    printf("Function mptKSPSolve_3args completed in %g seconds.\n", _timestamp);
...
void mptKSPSolve_4args_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&iter = prealloc_mxArray((mxArray**)&plhs[2], mxINT32_CLASS, 2, l_size); }
    ...
    mptKSPSolve_4args(&ksp, &b, &x, rtol, flag, relres, iter);

    _timestamp = M2C_wtime() - _timestamp;
    printf("Function mptKSPSolve_4args completed in %g seconds.\n", _timestamp);
...
void mptKSPSolve_6args_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    if (!mxIsStruct(prhs[0]))
        mexErrMsgIdAndTxt("mptKSPSolve_6args:WrongInputType",
            "Input argument ksp has incorrect data type. struct is expected.");
    if (mxGetNumberOfFields(prhs[0])!=3)
        mexErrMsgIdAndTxt("mptKSPSolve_6args:InputStructWrongFields",
            "Input argument ksp has incorrect number of fields.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("mptKSPSolve_6args:WrongSizeOfInputArg",
            "Argument ksp must contain 1 items.");

    _sub_mx1 = mxGetField(prhs[0], 0, "data");
    if (_sub_mx1==NULL)
        mexErrMsgIdAndTxt("mptKSPSolve_6args:WrongInputStruct",
            "Input argument ksp does not have the field data.");
    if (mxGetNumberOfElements(_sub_mx1) && mxGetClassID(_sub_mx1) != mxUINT8_CLASS)
        mexErrMsgIdAndTxt("mptKSPSolve_6args:WrongInputType",
            "Input argument ksp.data has incorrect data type. uint8 is expected.");
    ...
    *(void **)&iter = prealloc_mxArray((mxArray**)&plhs[2], mxINT32_CLASS, 2, l_size); }
    ...
    mptKSPSolve_6args(&ksp, &b, &x, rtol, maxiter, &x0, flag, relres, iter);

    _timestamp = M2C_wtime() - _timestamp;
    printf("Function mptKSPSolve_6args completed in %g seconds.\n", _timestamp);
...
void mptKSPSolve_7args_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    if (!mxIsStruct(prhs[0]))
        mexErrMsgIdAndTxt("mptKSPSolve_7args:WrongInputType",
            "Input argument ksp has incorrect data type. struct is expected.");
    if (mxGetNumberOfFields(prhs[0])!=3)
        mexErrMsgIdAndTxt("mptKSPSolve_7args:InputStructWrongFields",
            "Input argument ksp has incorrect number of fields.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("mptKSPSolve_7args:WrongSizeOfInputArg",
            "Argument ksp must contain 1 items.");

    _sub_mx1 = mxGetField(prhs[0], 0, "data");
    if (_sub_mx1==NULL)
        mexErrMsgIdAndTxt("mptKSPSolve_7args:WrongInputStruct",
            "Input argument ksp does not have the field data.");
    if (mxGetNumberOfElements(_sub_mx1) && mxGetClassID(_sub_mx1) != mxUINT8_CLASS)
        mexErrMsgIdAndTxt("mptKSPSolve_7args:WrongInputType",
            "Input argument ksp.data has incorrect data type. uint8 is expected.");
    ...
    *(void**)&x0.type = mxCalloc(1, sizeof(emxArray__common));
    ...
    if (!mxIsStruct(prhs[6]))
        mexErrMsgIdAndTxt("mptKSPSolve_7args:WrongInputType",
            "Input argument resvec has incorrect data type. struct is expected.");
    if (mxGetNumberOfFields(prhs[6])!=3)
        mexErrMsgIdAndTxt("mptKSPSolve_7args:InputStructWrongFields",
            "Input argument resvec has incorrect number of fields.");
    if (mxGetNumberOfElements(prhs[6]) != 1)
        mexErrMsgIdAndTxt("mptKSPSolve_7args:WrongSizeOfInputArg",
            "Argument resvec must contain 1 items.");

    _sub_mx1 = mxGetField(prhs[6], 0, "data");
    if (_sub_mx1==NULL)
        mexErrMsgIdAndTxt("mptKSPSolve_7args:WrongInputStruct",
            "Input argument resvec does not have the field data.");
    if (mxGetNumberOfElements(_sub_mx1) && mxGetClassID(_sub_mx1) != mxUINT8_CLASS)
        mexErrMsgIdAndTxt("mptKSPSolve_7args:WrongInputType",
            "Input argument resvec.data has incorrect data type. uint8 is expected.");
    *(void**)&resvec.data = mxCalloc(1, sizeof(emxArray__common));
    alias_mxArray_to_emxArray(_sub_mx1, (emxArray__common*)resvec.data, "resvec.data", 1);
    _sub_mx1 = mxGetField(prhs[6], 0, "type");
    if (_sub_mx1==NULL)
        mexErrMsgIdAndTxt("mptKSPSolve_7args:WrongInputStruct",
            "Input argument resvec does not have the field type.");
    if (mxGetNumberOfElements(_sub_mx1) && mxGetClassID(_sub_mx1) != mxCHAR_CLASS)
        mexErrMsgIdAndTxt("mptKSPSolve_7args:WrongInputType",
            "Input argument resvec.type has incorrect data type. char is expected.");
    *(void**)&resvec.type = mxCalloc(1, sizeof(emxArray__common));
    alias_mxArray_to_emxArray(_sub_mx1, (emxArray__common*)resvec.type, "resvec.type", 2);
    _sub_mx1 = mxGetField(prhs[6], 0, "nitems");
    if (_sub_mx1==NULL)
        mexErrMsgIdAndTxt("mptKSPSolve_7args:WrongInputStruct",
            "Input argument resvec does not have the field nitems.");
    if (mxGetNumberOfElements(_sub_mx1) && mxGetClassID(_sub_mx1) != mxINT32_CLASS)
        mexErrMsgIdAndTxt("mptKSPSolve_7args:WrongInputType",
            "Input argument resvec.nitems has incorrect data type. int32 is expected.");
    if (mxGetNumberOfElements(_sub_mx1) != 1)
        mexErrMsgIdAndTxt("mptKSPSolve_7args:WrongSizeOfInputArg",
            "Argument resvec.nitems should be a scalar.");
    resvec.nitems = *(int32_T*)mxGetData(_sub_mx1);
    ...
    *(void **)&iter = prealloc_mxArray((mxArray**)&plhs[2], mxINT32_CLASS, 2, l_size); }
    ...
    mptKSPSolve_7args(&ksp, &b, &x, rtol, maxiter, &x0, &resvec, flag, relres, iter);

    _timestamp = M2C_wtime() - _timestamp;
    printf("Function mptKSPSolve_7args completed in %g seconds.\n", _timestamp);
    ...
    free_emxArray((emxArray__common*)resvec.type); mxFree(resvec.type);
    free_emxArray((emxArray__common*)resvec.data); mxFree(resvec.data);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 5) {
        ...
        if (nlhs > 3)
            mexErrMsgIdAndTxt("mptKSPSolve_6args:TooManyOutputArguments","Too many output arguments for entry-point mptKSPSolve_6args.");
        /* Call the API function. */
        mptKSPSolve_6args_api(prhs, (const mxArray**)outputs);
    }
    else if (nrhs == 7) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("mptKSPSolve_7args:TooManyOutputArguments","Too many output arguments for entry-point mptKSPSolve_7args.");
        /* Call the API function. */
        mptKSPSolve_7args_api(prhs, (const mxArray**)outputs);
    }
    else
