 ...
 * %#m2c options: codegenArgs=-args {PetscKSP, PetscVec, PetscVec, 0, int32(0), PetscVec} mptKSPSolve_2args -args {PetscKSP, PetscVec} mptKSPSolve_3args -args {PetscKSP, PetscVec, PetscVec} mptKSPSolve_4args -args {PetscKSP, PetscVec, PetscVec, 0} mptKSPSolve_5args -args {PetscKSP, PetscVec, PetscVec, 0, int32(0)}  enableInline=1 timing={''} withPetsc=1
 *
 */
...
void mptKSPSolve_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&iter = prealloc_mxArray((mxArray**)&plhs[2], mxINT32_CLASS, 2, l_size); }
    ...
    mptKSPSolve(&ksp, &b, &x, rtol, maxits, &x0, flag, relres, iter);
...
void mptKSPSolve_5args_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&iter = prealloc_mxArray((mxArray**)&plhs[2], mxINT32_CLASS, 2, l_size); }
    ...
    mptKSPSolve_5args(&ksp, &b, &x, rtol, maxiter, flag, relres, iter);
