#ifndef MPTMATAIJTOCRS_H
#define MPTMATAIJTOCRS_H
#include <math.h>
#include <stddef.h>
#include <stdlib.h>
#include <string.h>
#include "rtwtypes.h"
#include "mptMatAIJToCRS_types.h"
...
extern void mptMatAIJToCRS(const struct0_T *mat, emxArray_int32_T *row_ptr,
  emxArray_int32_T *col_ind, emxArray_real_T *val);
extern void mptMatAIJToCRS_initialize(void);
extern void mptMatAIJToCRS_terminate(void);
