...
void mptSolveCRS_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&iter = prealloc_mxArray((mxArray**)&plhs[3], mxINT32_CLASS, 2, l_size); }
    ...
    /* Creating empty mxArray for pruned variable rv */
    {mwSize l_size[] = {0, 1};
...
void mptSolveCRS_4args_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&relres = prealloc_mxArray((mxArray**)&plhs[2], mxDOUBLE_CLASS, 2, l_size); }
    {mwSize l_size[] = {1, 1};
    *(void **)&iter = prealloc_mxArray((mxArray**)&plhs[3], mxINT32_CLASS, 2, l_size); }
    init_emxArray((emxArray__common*)&rv, 1);
    ...
    mptSolveCRS_4args(&Arows, &Acols, &Avals, &b, &x, flag, relres, iter, &rv);

    _timestamp = M2C_wtime() - _timestamp;
    printf("Function mptSolveCRS_4args completed in %g seconds.\n", _timestamp);
    ...
    /* Nothing to do for plhs[2] */
    /* Nothing to do for plhs[3] */
    plhs[4] = move_emxArray_to_mxArray((emxArray__common*)&rv, mxDOUBLE_CLASS);
    ...
    free_emxArray((emxArray__common*)&rv);
}
void mptSolveCRS_5args_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&iter = prealloc_mxArray((mxArray**)&plhs[3], mxINT32_CLASS, 2, l_size); }
    ...
    mptSolveCRS_5args(&Arows, &Acols, &Avals, &b, &solver, &x, flag, relres, iter, &rv);

    _timestamp = M2C_wtime() - _timestamp;
    printf("Function mptSolveCRS_5args completed in %g seconds.\n", _timestamp);
...
void mptSolveCRS_6args_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&iter = prealloc_mxArray((mxArray**)&plhs[3], mxINT32_CLASS, 2, l_size); }
    ...
    mptSolveCRS_6args(&Arows, &Acols, &Avals, &b, &solver, rtol, &x, flag, relres, iter, &rv);

    _timestamp = M2C_wtime() - _timestamp;
    printf("Function mptSolveCRS_6args completed in %g seconds.\n", _timestamp);
...
void mptSolveCRS_7args_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&iter = prealloc_mxArray((mxArray**)&plhs[3], mxINT32_CLASS, 2, l_size); }
    ...
    mptSolveCRS_7args(&Arows, &Acols, &Avals, &b, &solver, rtol, maxiter, &x, flag, relres, iter, &rv);

    _timestamp = M2C_wtime() - _timestamp;
    printf("Function mptSolveCRS_7args completed in %g seconds.\n", _timestamp);
...
void mptSolveCRS_8args_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&iter = prealloc_mxArray((mxArray**)&plhs[3], mxINT32_CLASS, 2, l_size); }
    ...
    mptSolveCRS_8args(&Arows, &Acols, &Avals, &b, &solver, rtol, maxiter, &pctype, &x, flag, relres, iter, &rv);

    _timestamp = M2C_wtime() - _timestamp;
    printf("Function mptSolveCRS_8args completed in %g seconds.\n", _timestamp);
...
void mptSolveCRS_9args_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&iter = prealloc_mxArray((mxArray**)&plhs[3], mxINT32_CLASS, 2, l_size); }
    ...
    mptSolveCRS_9args(&Arows, &Acols, &Avals, &b, &solver, rtol, maxiter, &pctype, &solpack, &x, flag, relres, iter, &rv);

    _timestamp = M2C_wtime() - _timestamp;
    printf("Function mptSolveCRS_9args completed in %g seconds.\n", _timestamp);
...
void mptSolveCRS_10args_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&iter = prealloc_mxArray((mxArray**)&plhs[3], mxINT32_CLASS, 2, l_size); }
    ...
    mptSolveCRS_10args(&Arows, &Acols, &Avals, &b, &solver, rtol, maxiter, &pctype, &solpack, &x0, &x, flag, relres, iter, &rv);

    _timestamp = M2C_wtime() - _timestamp;
    printf("Function mptSolveCRS_10args completed in %g seconds.\n", _timestamp);
...
void mptSolveCRS_11args_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&iter = prealloc_mxArray((mxArray**)&plhs[3], mxINT32_CLASS, 2, l_size); }
    ...
    mptSolveCRS_11args(&Arows, &Acols, &Avals, &b, &solver, rtol, maxiter, &pctype, &solpack, &x0, &opts, &x, flag, relres, iter, &rv);

    _timestamp = M2C_wtime() - _timestamp;
    printf("Function mptSolveCRS_11args completed in %g seconds.\n", _timestamp);
