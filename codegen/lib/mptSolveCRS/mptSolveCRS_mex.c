...
static void __mptSolveCRS_api(mxArray **plhs, const mxArray ** prhs) {
    int32_T             *flag;
    real64_T            *relres;
    int32_T             *iter;
    real64_T            *times;
    ...
    mptSolveCRS(flag, relres, iter, times);
...
static void __mptSolveCRS_4args_api(mxArray **plhs, const mxArray ** prhs) {
    ...
    if (mxGetNumberOfElements(prhs[0]) && mxGetDimensions(prhs[0])[1] != 1) 
        mexErrMsgIdAndTxt("mptSolveCRS_4args:WrongSizeOfInputArg",
            "Dimension 2 of Arows should equal 1.");
    ...
    if (mxGetNumberOfElements(prhs[1]) && mxGetDimensions(prhs[1])[1] != 1) 
        mexErrMsgIdAndTxt("mptSolveCRS_4args:WrongSizeOfInputArg",
            "Dimension 2 of Acols should equal 1.");
    ...
    if (mxGetNumberOfElements(prhs[2]) && mxGetDimensions(prhs[2])[1] != 1) 
        mexErrMsgIdAndTxt("mptSolveCRS_4args:WrongSizeOfInputArg",
            "Dimension 2 of Avals should equal 1.");
...
static void __mptSolveCRS_5args_api(mxArray **plhs, const mxArray ** prhs) {
    emxArray_int32_T     Arows;
    emxArray_int32_T     Acols;
    emxArray_real_T      Avals;
    emxArray_real_T      b;
    ...
    if (mxGetNumberOfElements(prhs[0]) && mxGetClassID(prhs[0]) != mxINT32_CLASS)
        mexErrMsgIdAndTxt("mptSolveCRS_5args:WrongInputType",
            "Input argument Arows has incorrect data type; int32 is expected.");
    if (mxGetNumberOfElements(prhs[0]) && mxGetDimensions(prhs[0])[1] != 1) 
        mexErrMsgIdAndTxt("mptSolveCRS_5args:WrongSizeOfInputArg",
            "Dimension 2 of Arows should equal 1.");
    alias_mxArray_to_emxArray(prhs[0], (emxArray__common *)(&Arows), "Arows", 1);
    ...
    if (mxGetNumberOfElements(prhs[4]) && mxGetDimensions(prhs[4])[0] != 1) 
        mexErrMsgIdAndTxt("mptSolveCRS_5args:WrongSizeOfInputArg",
            "Dimension 1 of solver should equal 1.");
...
static void __mptSolveCRS_6args_api(mxArray **plhs, const mxArray ** prhs) {
    emxArray_int32_T     Arows;
    emxArray_int32_T     Acols;
    emxArray_real_T      Avals;
    emxArray_real_T      b;
...
static void __mptSolveCRS_7args_api(mxArray **plhs, const mxArray ** prhs) {
    emxArray_int32_T     Arows;
    emxArray_int32_T     Acols;
    emxArray_real_T      Avals;
    emxArray_real_T      b;
...
static void __mptSolveCRS_8args_api(mxArray **plhs, const mxArray ** prhs) {
    emxArray_int32_T     Arows;
    emxArray_int32_T     Acols;
    emxArray_real_T      Avals;
    emxArray_real_T      b;
    ...
    if (mxGetNumberOfElements(prhs[7]) && mxGetDimensions(prhs[7])[0] != 1) 
        mexErrMsgIdAndTxt("mptSolveCRS_8args:WrongSizeOfInputArg",
            "Dimension 1 of pctype should equal 1.");
...
static void __mptSolveCRS_9args_api(mxArray **plhs, const mxArray ** prhs) {
    emxArray_int32_T     Arows;
    emxArray_int32_T     Acols;
    emxArray_real_T      Avals;
    emxArray_real_T      b;
    ...
    if (mxGetNumberOfElements(prhs[8]) && mxGetDimensions(prhs[8])[0] != 1) 
        mexErrMsgIdAndTxt("mptSolveCRS_9args:WrongSizeOfInputArg",
            "Dimension 1 of solpack should equal 1.");
...
static void __mptSolveCRS_10args_api(mxArray **plhs, const mxArray ** prhs) {
    emxArray_int32_T     Arows;
    emxArray_int32_T     Acols;
    emxArray_real_T      Avals;
    emxArray_real_T      b;
...
static void __mptSolveCRS_11args_api(mxArray **plhs, const mxArray ** prhs) {
    emxArray_int32_T     Arows;
    emxArray_int32_T     Acols;
    emxArray_real_T      Avals;
    emxArray_real_T      b;
    ...
    if (mxGetNumberOfElements(prhs[10]) && mxGetDimensions(prhs[10])[0] != 1) 
        mexErrMsgIdAndTxt("mptSolveCRS_11args:WrongSizeOfInputArg",
            "Dimension 1 of opts should equal 1.");
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 0) {
        if (nlhs > 6)
            mexErrMsgIdAndTxt("mptSolveCRS:TooManyOutputArguments",
                "Too many output arguments for entry-point mptSolveCRS.\n");
        /* Call the API function. */
        __mptSolveCRS_api(outputs, prhs);
    }
    else if (nrhs == 4) {
        if (nlhs > 6)
            mexErrMsgIdAndTxt("mptSolveCRS_4args:TooManyOutputArguments",
                "Too many output arguments for entry-point mptSolveCRS_4args.\n");
        /* Call the API function. */
        __mptSolveCRS_4args_api(outputs, prhs);
    }
    else if (nrhs == 5) {
        if (nlhs > 6)
            mexErrMsgIdAndTxt("mptSolveCRS_5args:TooManyOutputArguments",
                "Too many output arguments for entry-point mptSolveCRS_5args.\n");
        /* Call the API function. */
        __mptSolveCRS_5args_api(outputs, prhs);
    }
    else if (nrhs == 6) {
        if (nlhs > 6)
            mexErrMsgIdAndTxt("mptSolveCRS_6args:TooManyOutputArguments",
                "Too many output arguments for entry-point mptSolveCRS_6args.\n");
        /* Call the API function. */
        __mptSolveCRS_6args_api(outputs, prhs);
    }
    else if (nrhs == 7) {
        if (nlhs > 6)
            mexErrMsgIdAndTxt("mptSolveCRS_7args:TooManyOutputArguments",
                "Too many output arguments for entry-point mptSolveCRS_7args.\n");
        /* Call the API function. */
        __mptSolveCRS_7args_api(outputs, prhs);
    }
    else if (nrhs == 8) {
        if (nlhs > 6)
            mexErrMsgIdAndTxt("mptSolveCRS_8args:TooManyOutputArguments",
                "Too many output arguments for entry-point mptSolveCRS_8args.\n");
        /* Call the API function. */
        __mptSolveCRS_8args_api(outputs, prhs);
    }
    else if (nrhs == 9) {
        if (nlhs > 6)
            mexErrMsgIdAndTxt("mptSolveCRS_9args:TooManyOutputArguments",
                "Too many output arguments for entry-point mptSolveCRS_9args.\n");
        /* Call the API function. */
        __mptSolveCRS_9args_api(outputs, prhs);
    }
    else if (nrhs == 10) {
        if (nlhs > 6)
            mexErrMsgIdAndTxt("mptSolveCRS_10args:TooManyOutputArguments",
                "Too many output arguments for entry-point mptSolveCRS_10args.\n");
        /* Call the API function. */
        __mptSolveCRS_10args_api(outputs, prhs);
    }
    else if (nrhs == 11) {
        if (nlhs > 6)
            mexErrMsgIdAndTxt("mptSolveCRS_11args:TooManyOutputArguments",
                "Too many output arguments for entry-point mptSolveCRS_11args.\n");
        /* Call the API function. */
        __mptSolveCRS_11args_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("mptSolveCRS:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point mptSolveCRS.");
