 ...
 * %#m2c options: codegenArgs=-args {PetscMat, PetscKSPType, PetscPCType, PetscMatSolverPackage} mptKSPSetup_1arg -args {PetscMat} mptKSPSetup_2args -args {PetscMat, PetscKSPType} mptKSPSetup_3args -args {PetscMat, PetscKSPType, PetscPCType} enableInline=1 presVars=None dynMem=AllVariableSizeArrays
 *
 */
...
void mptKSPSetup_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void**)&Amat.type = mxCalloc(1, sizeof(emxArray__common));
    ...
    if (mxGetNumberOfElements(prhs[1]) && mxGetDimensions(prhs[1])[0] != 1)
        mexErrMsgIdAndTxt("mptKSPSetup:WrongSizeOfInputArg",
            "Dimension 1 of ksptype should be equal to 1.");
    ...
    if (mxGetNumberOfElements(prhs[3]) && mxGetDimensions(prhs[3])[0] != 1)
        mexErrMsgIdAndTxt("mptKSPSetup:WrongSizeOfInputArg",
            "Dimension 1 of pcopt should be equal to 1.");
