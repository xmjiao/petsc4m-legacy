 ...
 * %#m2c options: codegenArgs=-args {PetscMat, PetscKSPType, PetscPCType, PetscMatSolverPackage} mptKSPSetup_1arg -args {PetscMat} mptKSPSetup_2args -args {PetscMat, PetscKSPType} mptKSPSetup_3args -args {PetscMat, PetscKSPType, PetscPCType}  enableInline=1
 *
 */
