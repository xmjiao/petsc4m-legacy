 ...
 * %#m2c options: codegenArgs=-args {PetscKSP} enableInline=1 presVars=None dynMem=AllVariableSizeArrays
 *
 */
...
void mptKSPCleanup_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void**)&ksp.type = mxCalloc(1, sizeof(emxArray__common));
    ...
    /* Creating empty mxArray for pruned variable toplevel */
    {mwSize l_size[] = {1, 1};
    prealloc_mxArray((mxArray**)&plhs[1], mxLOGICAL_CLASS, 2, l_size); }
