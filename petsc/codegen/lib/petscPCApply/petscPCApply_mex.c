/*
 * petsc/codegen/lib/petscPCApply/petscPCApply_mex.c
 *
 * Auxiliary code for mexFunction of petscPCApply
 *
 * C source code generated by m2c.
 * %#m2c options: codegenArgs=-args {PetscPC, PetscVec, PetscVec} petscPCApply_2args -args {PetscPC, PetscVec}  enableInline=1 withPetsc=1
 *
 */
