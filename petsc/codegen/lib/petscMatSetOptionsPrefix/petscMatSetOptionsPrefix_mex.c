/*
 * petsc/codegen/lib/petscMatSetOptionsPrefix/petscMatSetOptionsPrefix_mex.c
 *
 * Auxiliary code for mexFunction of petscMatSetOptionsPrefix
 *
 * C source code generated by m2c.
 * %#m2c options: codegenArgs=-args {PetscMat, coder.typeof(char(0), [1, inf])}  enableInline=1 withPetsc=1
 *
 */
