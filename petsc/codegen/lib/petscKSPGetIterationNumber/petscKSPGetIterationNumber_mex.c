/*
 * petsc/codegen/lib/petscKSPGetIterationNumber/petscKSPGetIterationNumber_mex.c
 *
...
void petscKSPGetIterationNumber_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[2], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscKSPGetIterationNumber_initialize();

    petscKSPGetIterationNumber(&ksp, its, errCode, toplevel);

    petscKSPGetIterationNumber_terminate();
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscKSPGetIterationNumber:TooManyOutputArguments","Too many output arguments for entry-point petscKSPGetIterationNumber.");
        /* Call the API function. */
        petscKSPGetIterationNumber_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPGetIterationNumber:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscKSPGetIterationNumber.");
