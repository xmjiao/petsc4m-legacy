/*
 * petsc/codegen/lib/petscKSPGetType/petscKSPGetType_mex.c
 *
...
void petscKSPGetType_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[2], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscKSPGetType_initialize();

    petscKSPGetType(&ksp, &type, errCode, toplevel);

    petscKSPGetType_terminate();
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscKSPGetType:TooManyOutputArguments","Too many output arguments for entry-point petscKSPGetType.");
        /* Call the API function. */
        petscKSPGetType_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPGetType:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscKSPGetType.");
