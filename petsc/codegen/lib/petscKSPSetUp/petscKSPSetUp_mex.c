/*
 * petsc/codegen/lib/petscKSPSetUp/petscKSPSetUp_mex.c
 *
 * Auxiliary code for mexFunction of petscKSPSetUp
 *
...
void petscKSPSetUp_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[1], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscKSPSetUp_initialize();

    petscKSPSetUp(&ksp, errCode, toplevel);

    petscKSPSetUp_terminate();
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscKSPSetUp:TooManyOutputArguments","Too many output arguments for entry-point petscKSPSetUp.");
        /* Call the API function. */
        petscKSPSetUp_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPSetUp:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscKSPSetUp.");
