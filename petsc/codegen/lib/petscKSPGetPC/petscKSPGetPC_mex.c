/*
 * petsc/codegen/lib/petscKSPGetPC/petscKSPGetPC_mex.c
 *
 * Auxiliary code for mexFunction of petscKSPGetPC
 *
...
void petscKSPGetPC_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[2], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscKSPGetPC_initialize();

    petscKSPGetPC(&ksp, &pc, errCode, toplevel);

    petscKSPGetPC_terminate();
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscKSPGetPC:TooManyOutputArguments","Too many output arguments for entry-point petscKSPGetPC.");
        /* Call the API function. */
        petscKSPGetPC_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPGetPC:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscKSPGetPC.");
