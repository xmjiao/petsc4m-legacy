/*
 * petsc/codegen/lib/petscVecGetLocalSize/petscVecGetLocalSize_mex.c
 *
...
void petscVecGetLocalSize_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[2], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscVecGetLocalSize_initialize();

    petscVecGetLocalSize(&vec, n, errCode, toplevel);

    petscVecGetLocalSize_terminate();
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscVecGetLocalSize:TooManyOutputArguments","Too many output arguments for entry-point petscVecGetLocalSize.");
        /* Call the API function. */
        petscVecGetLocalSize_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscVecGetLocalSize:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscVecGetLocalSize.");
