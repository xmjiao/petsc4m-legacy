/*
 * petsc/codegen/lib/petscMatSetSizes/petscMatSetSizes_mex.c
 *
 * Auxiliary code for mexFunction of petscMatSetSizes
 *
 * C source code generated by m2c.
 * %#m2c options: codegenArgs=-args {PetscMat, int32(0), int32(0), int32(0), int32(0)} petscMatSetSizes_Local -args {PetscMat, int32(0), int32(0)}  enableInline=1 withPetsc=1
 *
 */
