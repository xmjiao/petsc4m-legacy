/*
 * petsc/codegen/lib/petscMatDestroy/petscMatDestroy_mex.c
 *
...
void petscMatDestroy_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[2], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscMatDestroy_initialize();

    petscMatDestroy(&mat, errCode, toplevel);

    petscMatDestroy_terminate();
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscMatDestroy:TooManyOutputArguments","Too many output arguments for entry-point petscMatDestroy.");
        /* Call the API function. */
        petscMatDestroy_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscMatDestroy:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscMatDestroy.");
