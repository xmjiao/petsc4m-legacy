/*
 * petsc/codegen/lib/petscMatAssemblyEnd/petscMatAssemblyEnd_mex.c
 *
 * Auxiliary code for mexFunction of petscMatAssemblyEnd
 *
 * C source code generated by m2c.
 * %#m2c options: codegenArgs=-args {PetscMat,int32(0)} petscMatAssemblyEnd_Final -args {PetscMat}  enableInline=1 withPetsc=1
 *
 */
