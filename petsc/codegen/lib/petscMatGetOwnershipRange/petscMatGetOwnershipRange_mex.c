/*
 * petsc/codegen/lib/petscMatGetOwnershipRange/petscMatGetOwnershipRange_mex.c
 *
 * Auxiliary code for mexFunction of petscMatGetOwnershipRange
 *
 * C source code generated by m2c.
 * %#m2c options: codegenArgs=-args {PetscMat}  enableInline=1 withPetsc=1
 *
 */
...
void petscMatGetOwnershipRange_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    if (!mxIsStruct(prhs[0]))
        mexErrMsgIdAndTxt("petscMatGetOwnershipRange:WrongInputType",
            "Input argument mat has incorrect data type. struct is expected.");
    if (mxGetNumberOfFields(prhs[0])!=3)
        mexErrMsgIdAndTxt("petscMatGetOwnershipRange:InputStructWrongFields",
            "Input argument mat has incorrect number of fields.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("petscMatGetOwnershipRange:WrongSizeOfInputArg",
            "Argument mat must contain 1 items.");

    _sub_mx1 = mxGetField(prhs[0], 0, "data");
    if (_sub_mx1==NULL)
        mexErrMsgIdAndTxt("petscMatGetOwnershipRange:WrongInputStruct",
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[3], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscMatGetOwnershipRange_initialize();

    petscMatGetOwnershipRange(&mat, first_row, last_row, errCode, toplevel);

    petscMatGetOwnershipRange_terminate();
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 4)
            mexErrMsgIdAndTxt("petscMatGetOwnershipRange:TooManyOutputArguments","Too many output arguments for entry-point petscMatGetOwnershipRange.");
        /* Call the API function. */
        petscMatGetOwnershipRange_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscMatGetOwnershipRange:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscMatGetOwnershipRange.");
