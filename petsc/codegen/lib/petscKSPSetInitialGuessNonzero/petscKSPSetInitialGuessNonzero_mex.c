/*
 * petsc/codegen/lib/petscKSPSetInitialGuessNonzero/petscKSPSetInitialGuessNonzero_mex.c
 *
 * Auxiliary code for mexFunction of petscKSPSetInitialGuessNonzero
 *
 * C source code generated by m2c.
 * %#m2c options: codegenArgs=-args {PetscKSP, int32(0)}  enableInline=1 withPetsc=1
 *
 */
