/*
 * petsc/codegen/lib/petscPCSetOperators/petscPCSetOperators_mex.c
 *
 * Auxiliary code for mexFunction of petscPCSetOperators
 *
 * C source code generated by m2c.
 * %#m2c options: codegenArgs=-args {PetscPC, PetscMat, PetscMat} petscPCSetOperators_AforP -args {PetscPC, PetscMat}  enableInline=1 withPetsc=1
 *
 */
