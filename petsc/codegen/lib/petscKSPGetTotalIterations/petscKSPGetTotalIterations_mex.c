/*
 * petsc/codegen/lib/petscKSPGetTotalIterations/petscKSPGetTotalIterations_mex.c
 *
...
void petscKSPGetTotalIterations_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    if (mxGetNumberOfFields(prhs[0])!=3)
        mexErrMsgIdAndTxt("petscKSPGetTotalIterations:InputStructWrongFields",
    ...
    if (_sub_mx1==NULL)
        mexErrMsgIdAndTxt("petscKSPGetTotalIterations:WrongInputStruct",
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[2], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscKSPGetTotalIterations_initialize();

    petscKSPGetTotalIterations(&ksp, its, errCode, toplevel);

    petscKSPGetTotalIterations_terminate();
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscKSPGetTotalIterations:TooManyOutputArguments","Too many output arguments for entry-point petscKSPGetTotalIterations.");
        /* Call the API function. */
        petscKSPGetTotalIterations_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPGetTotalIterations:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscKSPGetTotalIterations.");
