/*
 * petsc/codegen/lib/petscMatAssembled/petscMatAssembled_mex.c
 *
...
void petscMatAssembled_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[2], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscMatAssembled_initialize();

    petscMatAssembled(&mat, assembled, errCode, toplevel);

    petscMatAssembled_terminate();
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscMatAssembled:TooManyOutputArguments","Too many output arguments for entry-point petscMatAssembled.");
        /* Call the API function. */
        petscMatAssembled_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscMatAssembled:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscMatAssembled.");
