/*
 * petsc/codegen/lib/petscMatGetSize/petscMatGetSize_mex.c
 *
...
void petscMatGetSize_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[3], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscMatGetSize_initialize();

    petscMatGetSize(&mat, m, n, errCode, toplevel);

    petscMatGetSize_terminate();
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 4)
            mexErrMsgIdAndTxt("petscMatGetSize:TooManyOutputArguments","Too many output arguments for entry-point petscMatGetSize.");
        /* Call the API function. */
        petscMatGetSize_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscMatGetSize:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscMatGetSize.");
