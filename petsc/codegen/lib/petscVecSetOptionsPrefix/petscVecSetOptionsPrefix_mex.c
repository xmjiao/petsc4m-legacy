/*
 * petsc/codegen/lib/petscVecSetOptionsPrefix/petscVecSetOptionsPrefix_mex.c
 *
 * Auxiliary code for mexFunction of petscVecSetOptionsPrefix
 *
 * C source code generated by m2c.
 * %#m2c options: codegenArgs=-args {PetscVec, coder.typeof(char(0), [1, inf])}  enableInline=1 withPetsc=1
 *
 */
...
void petscVecSetOptionsPrefix_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    if (mxGetNumberOfFields(prhs[0])!=3)
        mexErrMsgIdAndTxt("petscVecSetOptionsPrefix:InputStructWrongFields",
    ...
    if (_sub_mx1==NULL)
        mexErrMsgIdAndTxt("petscVecSetOptionsPrefix:WrongInputStruct",
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[1], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscVecSetOptionsPrefix_initialize();

    petscVecSetOptionsPrefix(&vec, &prefix, errCode, toplevel);

    petscVecSetOptionsPrefix_terminate();
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 2) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscVecSetOptionsPrefix:TooManyOutputArguments","Too many output arguments for entry-point petscVecSetOptionsPrefix.");
        /* Call the API function. */
        petscVecSetOptionsPrefix_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscVecSetOptionsPrefix:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscVecSetOptionsPrefix.");
