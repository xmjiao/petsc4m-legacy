/*
 * petsc/codegen/lib/petscKSPDestroy/petscKSPDestroy_mex.c
 *
 * Auxiliary code for mexFunction of petscKSPDestroy
 *
...
void petscKSPDestroy_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&ksp_out.data = mxCalloc(1, sizeof(emxArray__common));    init_emxArray((emxArray__common*)ksp_out.data, 1);
    *(void **)&ksp_out.type = mxCalloc(1, sizeof(emxArray__common));    init_emxArray((emxArray__common*)ksp_out.type, 2);
    {mwSize l_size[] = {1, 1};
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[2], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscKSPDestroy_initialize();

    petscKSPDestroy(&ksp, &ksp_out, errCode, toplevel);

    petscKSPDestroy_terminate();

    /* Marshall out function outputs */
    {const char *_fields[] = { "data", "type", "nitems",  ""};
    int32_T _one=1;
    plhs[0] = create_struct_mxArray(1, &_one, 3, _fields);}
    mxSetFieldByNumber((mxArray*)(plhs[0]), 0, 0, move_emxArray_to_mxArray((emxArray__common*)ksp_out.data, mxUINT8_CLASS));
    mxSetFieldByNumber((mxArray*)(plhs[0]), 0, 1, move_emxArray_to_mxArray((emxArray__common*)ksp_out.type, mxCHAR_CLASS));
    mxSetFieldByNumber((mxArray*)(plhs[0]), 0, 2, copy_scalar_to_mxArray(&ksp_out.nitems, mxINT32_CLASS));
    ...
    free_emxArray((emxArray__common*)ksp_out.type); mxFree(ksp_out.type);
    free_emxArray((emxArray__common*)ksp_out.data); mxFree(ksp_out.data);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscKSPDestroy:TooManyOutputArguments","Too many output arguments for entry-point petscKSPDestroy.");
        /* Call the API function. */
        petscKSPDestroy_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPDestroy:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscKSPDestroy.");
