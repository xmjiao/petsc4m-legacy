/*
 * petsc/codegen/lib/petscMatSeqAIJSetPreallocationCSR/petscMatSeqAIJSetPreallocationCSR_mex.c
 *
 * Auxiliary code for mexFunction of petscMatSeqAIJSetPreallocationCSR
 *
 * C source code generated by m2c.
 * %#m2c options: codegenArgs=-args {PetscMat, coder.typeof(int32(0), [inf,1]), coder.typeof(int32(0), [inf,1]), coder.typeof(0, [inf,1])} petscMatSeqAIJSetPreallocationCSR_Indexonly -args {PetscMat, coder.typeof(int32(0), [inf,1]), coder.typeof(int32(0), [inf,1])}  enableInline=1 withPetsc=1
 *
 */
