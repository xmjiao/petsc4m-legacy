/*
 * petsc/codegen/lib/petscPCSetOptionsPrefix/petscPCSetOptionsPrefix_mex.c
 *
...
void petscPCSetOptionsPrefix_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    if (mxGetNumberOfFields(prhs[0])!=3)
        mexErrMsgIdAndTxt("petscPCSetOptionsPrefix:InputStructWrongFields",
    ...
    if (_sub_mx1==NULL)
        mexErrMsgIdAndTxt("petscPCSetOptionsPrefix:WrongInputStruct",
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[1], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscPCSetOptionsPrefix_initialize();

    petscPCSetOptionsPrefix(&pc, &prefix, errCode, toplevel);

    petscPCSetOptionsPrefix_terminate();
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 2) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscPCSetOptionsPrefix:TooManyOutputArguments","Too many output arguments for entry-point petscPCSetOptionsPrefix.");
        /* Call the API function. */
        petscPCSetOptionsPrefix_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscPCSetOptionsPrefix:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscPCSetOptionsPrefix.");
