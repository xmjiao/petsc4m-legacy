/*
 * petsc/codegen/lib/petscPCFactorSetMatSolverPackage/petscPCFactorSetMatSolverPackage_mex.c
 *
 * Auxiliary code for mexFunction of petscPCFactorSetMatSolverPackage
 *
 * C source code generated by m2c.
 * %#m2c options: codegenArgs=-args {PetscPC, PetscMatSolverPackage}  enableInline=1 withPetsc=1
 *
 */
