/*
 * petsc/codegen/lib/petscMatAssemblyBegin/petscMatAssemblyBegin_mex.c
 *
 * Auxiliary code for mexFunction of petscMatAssemblyBegin
 *
 * C source code generated by m2c.
 * %#m2c options: codegenArgs=-args {PetscMat,int32(0)} petscMatAssemblyBegin_Final -args {PetscMat}  enableInline=1 withPetsc=1
 *
 */
