...
static void __petscKSPGetNormType_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscKSPGetNormType:TooManyOutputArguments",
                "Too many output arguments for entry-point petscKSPGetNormType.\n");
        /* Call the API function. */
        __petscKSPGetNormType_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPGetNormType:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscKSPGetNormType.");
