...
static void __petscKSPGetOptionsPrefix_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscKSPGetOptionsPrefix:TooManyOutputArguments",
                "Too many output arguments for entry-point petscKSPGetOptionsPrefix.\n");
        /* Call the API function. */
        __petscKSPGetOptionsPrefix_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPGetOptionsPrefix:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscKSPGetOptionsPrefix.");
