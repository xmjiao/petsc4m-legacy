...
static void __petscKSPDestroy_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscKSPDestroy:TooManyOutputArguments",
                "Too many output arguments for entry-point petscKSPDestroy.\n");
        /* Call the API function. */
        __petscKSPDestroy_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPDestroy:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscKSPDestroy.");
