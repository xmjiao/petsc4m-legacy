 ...
 * %#m2c options:0cca5ec180ba03a6a22fc6f0d1fd8632
 *
 */
...
static void __petscKSPSetOperators_api(mxArray **plhs, const mxArray ** prhs) {
    ...
    marshallin_const_M2C_OpaqueType(&Amat, prhs[1], "Amat");
    ...
    marshallin_const_M2C_OpaqueType(&Pmat, prhs[2], "Pmat");
    ...
    destroy_M2C_OpaqueType(&Amat);
    destroy_M2C_OpaqueType(&Pmat);
