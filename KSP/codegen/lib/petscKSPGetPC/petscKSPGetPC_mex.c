...
static void __petscKSPGetPC_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscKSPGetPC:TooManyOutputArguments",
                "Too many output arguments for entry-point petscKSPGetPC.\n");
        /* Call the API function. */
        __petscKSPGetPC_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPGetPC:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscKSPGetPC.");
