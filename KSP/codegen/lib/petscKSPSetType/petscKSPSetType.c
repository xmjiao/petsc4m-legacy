...
static void b_m2c_error(int varargin_3)
{
  ...
  fmt = "KSPSetType returned error code %d\n";
...
void petscKSPSetType(const M2C_OpaqueType *ksp, const emxArray_char_T *type,
                     int *errCode, boolean_T *toplevel)
{
  ...
  *errCode = KSPSetType(c_ksp, &type->data[0]);
  *toplevel = true;
  if (*errCode != 0) {
    b_m2c_error(*errCode);
  }
...
void petscKSPSetType_initialize(void)
{
}

void petscKSPSetType_terminate(void)
{
}
