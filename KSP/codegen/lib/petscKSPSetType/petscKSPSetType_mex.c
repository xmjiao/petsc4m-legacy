...
static void __petscKSPSetType_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 2) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscKSPSetType:TooManyOutputArguments",
                "Too many output arguments for entry-point petscKSPSetType.\n");
        /* Call the API function. */
        __petscKSPSetType_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPSetType:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscKSPSetType.");
