...
static void b_m2c_error(int varargin_3)
{
  ...
  fmt = "KSPSetUp returned error code %d\n";
...
void petscKSPSetUp(const M2C_OpaqueType *ksp, int *errCode, boolean_T *toplevel)
{
...
void petscKSPSetUp_initialize(void)
{
}

void petscKSPSetUp_terminate(void)
{
}
