...
static void __petscKSPSetUp_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscKSPSetUp:TooManyOutputArguments",
                "Too many output arguments for entry-point petscKSPSetUp.\n");
        /* Call the API function. */
        __petscKSPSetUp_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPSetUp:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscKSPSetUp.");
