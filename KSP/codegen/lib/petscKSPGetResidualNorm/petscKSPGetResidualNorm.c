#include "petscKSPGetResidualNorm.h"
#include "m2c.h"
#include "petsc4m.h"
...
static void b_m2c_error(int varargin_3)
{
  ...
  fmt = "KSPGetResidualNorm returned error code %d\n";
...
void petscKSPGetResidualNorm(const struct0_T *ksp, double *rnorm, int *errCode,
  boolean_T *toplevel)
{
  boolean_T p;
  boolean_T b_p;
...
void petscKSPGetResidualNorm_initialize(void)
{
}

void petscKSPGetResidualNorm_terminate(void)
{
}
