#include "petscKSPGetConvergedReason.h"
#include "m2c.h"
#include "petsc4m.h"
...
static void b_m2c_error(int varargin_3)
{
  ...
  fmt = "KSPGetConvergedReason returned error code %d\n";
...
void petscKSPGetConvergedReason(const struct0_T *ksp, int *flag, int *errCode,
  boolean_T *toplevel)
{
  boolean_T p;
  boolean_T b_p;
...
void petscKSPGetConvergedReason_initialize(void)
{
}

void petscKSPGetConvergedReason_terminate(void)
{
}
