...
static void __petscKSPGetConvergedReason_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscKSPGetConvergedReason:TooManyOutputArguments",
                "Too many output arguments for entry-point petscKSPGetConvergedReason.\n");
        /* Call the API function. */
        __petscKSPGetConvergedReason_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPGetConvergedReason:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscKSPGetConvergedReason.");
