 ...
 * %#m2c options: codegenArgs=-args {PetscKSP} petscKSPSetResidualHistory_2args -args {PetscKSP, int32(0)} petscKSPSetResidualHistory_3args -args {PetscKSP, int32(0), int32(0)}  enableInline=1
 *
 */
