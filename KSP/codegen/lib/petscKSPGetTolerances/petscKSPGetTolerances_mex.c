/*
 * KSP/codegen/lib/petscKSPGetTolerances/petscKSPGetTolerances_mex.c
 *
 * Auxiliary code for mexFunction of petscKSPGetTolerances
 *
...
void petscKSPGetTolerances_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    if (!mxIsStruct(prhs[0]))
        mexErrMsgIdAndTxt("petscKSPGetTolerances:WrongInputType",
            "Input argument ksp has incorrect data type. struct is expected.");
    if (mxGetNumberOfFields(prhs[0])!=3)
        mexErrMsgIdAndTxt("petscKSPGetTolerances:InputStructWrongFields",
            "Input argument ksp has incorrect number of fields.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("petscKSPGetTolerances:WrongSizeOfInputArg",
            "Argument ksp must contain 1 items.");

    _sub_mx1 = mxGetField(prhs[0], 0, "data");
    if (_sub_mx1==NULL)
        mexErrMsgIdAndTxt("petscKSPGetTolerances:WrongInputStruct",
    ...
    *(void**)&ksp.type = mxCalloc(1, sizeof(emxArray__common));
    ...
    {mwSize l_size[] = {1, 1};
    *(void **)&rtol = prealloc_mxArray((mxArray**)&plhs[0], mxDOUBLE_CLASS, 2, l_size); }
    {mwSize l_size[] = {1, 1};
    *(void **)&abstol = prealloc_mxArray((mxArray**)&plhs[1], mxDOUBLE_CLASS, 2, l_size); }
    {mwSize l_size[] = {1, 1};
    *(void **)&dtol = prealloc_mxArray((mxArray**)&plhs[2], mxDOUBLE_CLASS, 2, l_size); }
    {mwSize l_size[] = {1, 1};
    *(void **)&maxits = prealloc_mxArray((mxArray**)&plhs[3], mxINT32_CLASS, 2, l_size); }
    {mwSize l_size[] = {1, 1};
    *(void **)&errCode = prealloc_mxArray((mxArray**)&plhs[4], mxINT32_CLASS, 2, l_size); }
    {mwSize l_size[] = {1, 1};
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[5], mxLOGICAL_CLASS, 2, l_size); }

    /* Invoke the target function */
    petscKSPGetTolerances_initialize();

    petscKSPGetTolerances(&ksp, rtol, abstol, dtol, maxits, errCode, toplevel);

    petscKSPGetTolerances_terminate();
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 6)
            mexErrMsgIdAndTxt("petscKSPGetTolerances:TooManyOutputArguments","Too many output arguments for entry-point petscKSPGetTolerances.");
        /* Call the API function. */
        petscKSPGetTolerances_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPGetTolerances:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscKSPGetTolerances.");
