...
static void b_m2c_error(int varargin_3)
{
  ...
  fmt = "KSPSetInitialGuessNonzero returned error code %d\n";
...
void petscKSPSetInitialGuessNonzero(const struct0_T *ksp, int flag, int *errCode,
  boolean_T *toplevel)
{
  boolean_T p;
  boolean_T b_p;
...
void petscKSPSetInitialGuessNonzero_initialize(void)
{
}

void petscKSPSetInitialGuessNonzero_terminate(void)
{
}
