...
static void __petscKSPSetInitialGuessNonzero_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 2) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscKSPSetInitialGuessNonzero:TooManyOutputArguments",
                "Too many output arguments for entry-point petscKSPSetInitialGuessNonzero.\n");
        /* Call the API function. */
        __petscKSPSetInitialGuessNonzero_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPSetInitialGuessNonzero:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscKSPSetInitialGuessNonzero.");
