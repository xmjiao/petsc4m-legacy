...
static void __petscKSPSetPCSide_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 2) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscKSPSetPCSide:TooManyOutputArguments",
                "Too many output arguments for entry-point petscKSPSetPCSide.\n");
        /* Call the API function. */
        __petscKSPSetPCSide_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPSetPCSide:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscKSPSetPCSide.");
