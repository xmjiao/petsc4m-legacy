...
static void b_m2c_error(int varargin_3)
{
  ...
  fmt = "KSPSetPCSide returned error code %d\n";
...
void petscKSPSetPCSide(const struct0_T *ksp, int side, int *errCode, boolean_T
  *toplevel)
{
  boolean_T p;
  boolean_T b_p;
  ...
  *errCode = KSPSetPCSide(c_ksp, side);
  *toplevel = true;
...
void petscKSPSetPCSide_initialize(void)
{
}

void petscKSPSetPCSide_terminate(void)
{
}
