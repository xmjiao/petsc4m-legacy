...
static void __petscKSPCreate_api(mxArray **plhs, const mxArray ** prhs) {
...
static void __petscKSPCreate_World_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscKSPCreate:TooManyOutputArguments",
                "Too many output arguments for entry-point petscKSPCreate.\n");
        /* Call the API function. */
        __petscKSPCreate_api(outputs, prhs);
    }
    else if (nrhs == 0) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscKSPCreate_World:TooManyOutputArguments",
                "Too many output arguments for entry-point petscKSPCreate_World.\n");
        /* Call the API function. */
        __petscKSPCreate_World_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPCreate:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscKSPCreate.");
