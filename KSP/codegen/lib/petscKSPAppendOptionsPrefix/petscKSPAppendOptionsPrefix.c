...
static void b_m2c_error(void)
{
  const char *fmt;
  const char *msgid;
  msgid = "Petsc4m:petscKSPAppendOptionsPrefix:InputError";
...
static void c_m2c_error(int varargin_3)
{
  ...
  fmt = "KSPAppendOptionsPrefix returned error code %d\n";
...
void petscKSPAppendOptionsPrefix(const M2C_OpaqueType *ksp,
