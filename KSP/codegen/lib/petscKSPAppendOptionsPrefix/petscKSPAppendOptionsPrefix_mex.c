...
static void __petscKSPAppendOptionsPrefix_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 2) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscKSPAppendOptionsPrefix:TooManyOutputArguments",
                "Too many output arguments for entry-point petscKSPAppendOptionsPrefix.\n");
        /* Call the API function. */
        __petscKSPAppendOptionsPrefix_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPAppendOptionsPrefix:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscKSPAppendOptionsPrefix.");
