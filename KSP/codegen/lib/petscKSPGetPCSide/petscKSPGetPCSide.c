...
static void b_m2c_error(int varargin_3)
{
  ...
  fmt = "KSPGetPCSide returned error code %d\n";
...
void petscKSPGetPCSide(const struct0_T *ksp, int *side, int *errCode, boolean_T *
  toplevel)
{
  boolean_T p;
  boolean_T b_p;
  ...
  *errCode = KSPGetPCSide(c_ksp, side);
  *toplevel = true;
...
void petscKSPGetPCSide_initialize(void)
{
}

void petscKSPGetPCSide_terminate(void)
{
}
