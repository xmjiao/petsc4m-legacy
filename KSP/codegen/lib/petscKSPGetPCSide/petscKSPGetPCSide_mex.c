/*
 * KSP/codegen/lib/petscKSPGetPCSide/petscKSPGetPCSide_mex.c
 *
 * Auxiliary code for mexFunction of petscKSPGetPCSide
 *
...
void petscKSPGetPCSide_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    if (!mxIsStruct(prhs[0]))
        mexErrMsgIdAndTxt("petscKSPGetPCSide:WrongInputType",
            "Input argument ksp has incorrect data type. struct is expected.");
    if (mxGetNumberOfFields(prhs[0])!=3)
        mexErrMsgIdAndTxt("petscKSPGetPCSide:InputStructWrongFields",
            "Input argument ksp has incorrect number of fields.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("petscKSPGetPCSide:WrongSizeOfInputArg",
            "Argument ksp must contain 1 items.");

    _sub_mx1 = mxGetField(prhs[0], 0, "data");
    if (_sub_mx1==NULL)
        mexErrMsgIdAndTxt("petscKSPGetPCSide:WrongInputStruct",
    ...
    *(void**)&ksp.type = mxCalloc(1, sizeof(emxArray__common));
    ...
    {mwSize l_size[] = {1, 1};
    *(void **)&side = prealloc_mxArray((mxArray**)&plhs[0], mxINT32_CLASS, 2, l_size); }
    {mwSize l_size[] = {1, 1};
    ...
    *(void **)&toplevel = prealloc_mxArray((mxArray**)&plhs[2], mxLOGICAL_CLASS, 2, l_size); }
    ...
    petscKSPGetPCSide_initialize();

    petscKSPGetPCSide(&ksp, side, errCode, toplevel);

    petscKSPGetPCSide_terminate();
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscKSPGetPCSide:TooManyOutputArguments","Too many output arguments for entry-point petscKSPGetPCSide.");
        /* Call the API function. */
        petscKSPGetPCSide_api(prhs, (const mxArray**)outputs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPGetPCSide:WrongNumberOfInputs","Incorrect number of input variables for entry-point petscKSPGetPCSide.");
