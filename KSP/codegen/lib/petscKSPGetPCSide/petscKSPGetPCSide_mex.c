...
static void __petscKSPGetPCSide_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscKSPGetPCSide:TooManyOutputArguments",
                "Too many output arguments for entry-point petscKSPGetPCSide.\n");
        /* Call the API function. */
        __petscKSPGetPCSide_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPGetPCSide:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscKSPGetPCSide.");
