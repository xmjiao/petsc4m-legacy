...
static void __petscKSPGetInitialGuessNonzero_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("petscKSPGetInitialGuessNonzero:TooManyOutputArguments",
                "Too many output arguments for entry-point petscKSPGetInitialGuessNonzero.\n");
        /* Call the API function. */
        __petscKSPGetInitialGuessNonzero_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPGetInitialGuessNonzero:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscKSPGetInitialGuessNonzero.");
