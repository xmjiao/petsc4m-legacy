...
static void __petscKSPSetFromOptions_api(mxArray **plhs, const mxArray ** prhs) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("petscKSPSetFromOptions:TooManyOutputArguments",
                "Too many output arguments for entry-point petscKSPSetFromOptions.\n");
        /* Call the API function. */
        __petscKSPSetFromOptions_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("petscKSPSetFromOptions:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point petscKSPSetFromOptions.");
